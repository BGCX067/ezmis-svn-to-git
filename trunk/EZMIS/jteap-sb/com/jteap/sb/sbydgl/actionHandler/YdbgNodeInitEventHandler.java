 ...
 *
 */
public class YdbgNodeInitEventHandler extends InitNodeEventHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		try {
			...
			} else if ("检修部会审".equals(taskNode.getName()) || "发电部会审".equals(taskNode.getName())) {
				status = "待审批";
				context.getContextInstance().setVariable("STATUS", status);
			...
			String sql = "update tb_sb_sbydgl_ydxx set status='"+status+"' where id='"+docid+"'";
