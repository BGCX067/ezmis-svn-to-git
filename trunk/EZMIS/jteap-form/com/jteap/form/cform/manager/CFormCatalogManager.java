...
public class CFormCatalogManager extends HibernateEntityDao<CFormCatalog> {
	...
	public Collection<CFormCatalog> findCatalogByParentId(String parentId){
		
		StringBuffer hql=new StringBuffer("from CFormCatalog as g where ");
		Object args[]=null;
