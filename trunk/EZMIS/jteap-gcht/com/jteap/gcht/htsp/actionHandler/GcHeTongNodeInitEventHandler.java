 ...
 *
 */
public class GcHeTongNodeInitEventHandler extends InitNodeEventHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		try {
			...
			} else if ("项目实施部门审批".equals(taskNode.getName())) {
				status = "申请审批";
				context.getContextInstance().setVariable("STATUS", status);
			...
			String sql = "update TB_HT_GCHT set status='"+status+"' where id='"+docid+"'";
