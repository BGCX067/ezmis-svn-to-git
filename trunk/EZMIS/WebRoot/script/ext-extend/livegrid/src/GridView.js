...
// {{{ ------------adjusted methods for applying custom behavior----------------
    ...
    renderUI : function()
    {
        ...
        if (this.loadMask) {
            ...
            this._loadMaskAnchor._mask.addClass('ext-ux-livegrid');
            this._loadMaskAnchor._mask.setDisplayed(false);
            this._loadMaskAnchor._maskMsg.setDisplayed(false);
        }
    },
...
// {{{ --------------------------helpers----------------------------------------
    ...
    showLoadMask : function(show)
    {
        ...
        var mask    = this._loadMaskAnchor._mask;
 	    var maskMsg = this._loadMaskAnchor._maskMsg;
