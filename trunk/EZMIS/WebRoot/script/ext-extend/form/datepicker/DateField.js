...
* @param {Object} config
 */
Ext.app.DateField = Ext.extend(Ext.form.TriggerField,  {
    /**
     * @cfg {String} format
    ...
    validateValue : function(value){
        ...
        if(!Ext.app.DateField.superclass.validateValue.call(this, value)){
            return false;
        }
     ...
     */
    getValue : function(){
        return this.parseDate(Ext.app.DateField.superclass.getValue.call(this)) || "";
    },
...
dateField.setValue('2006-05-04');
    ...
    setValue : function(date){
        Ext.app.DateField.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
    ...
    onDestroy : function(){
        ...
        Ext.app.DateField.superclass.onDestroy.call(this);
    },
...
Ext.reg('datefield', Ext.app.DateField);