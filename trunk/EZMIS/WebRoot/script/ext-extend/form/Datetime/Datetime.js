...
Ext.extend(DatetimePicker, Ext.DatePicker, {
	...
	*/
	...
	setValue : function(value){
		...
		if(typeof value == 'object' && value.time!=null){
 ...
 * DateTimeField
 */
Ext.app.DateTimeField = function(config){
	Ext.apply(config,{
		 menu:new DatetimeMenu()
	});
	Ext.app.DateTimeField.superclass.constructor.call(this, config);
}
Ext.extend(Ext.app.DateTimeField,Ext.form.DateField,{
   /* // private
...
Ext.reg('datetimefield', Ext.app.DateTimeField);
