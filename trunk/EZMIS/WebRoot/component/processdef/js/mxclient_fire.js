	...
	mxPopupMenu.prototype.showSubmenu = function(parent, row) {
		if (row.div != null) {
			...
			var right = (b.scrollLeft || d.scrollLeft)
					+ (b.clientWidth || d.clientWidth);
			if (left + width > right) {
				row.div.style.left = (parent.div.offsetLeft - width + ((false)
						? 6
						: -6))
						+ 'px';
			}
...

{
	...
	mxText.prototype.create = function(container) {
		var node = null;
		if (this.dialect == mxConstants.DIALECT_SVG
				&& (!true || !this.ENABLE_FOREIGNOBJECT)) {
			node = this.createSvg();
		} else if (this.dialect == mxConstants.DIALECT_STRICTHTML
				|| this.dialect == mxConstants.DIALECT_PREFERHTML
...

{
	...
	mxCellRenderer.prototype.getLabelValue = function(state) {
		...
		if (!graph.isHtmlLabel(state.cell)
				&& (value != null && !mxUtils.isNode(value)) && false) {
...

{
	...
	mxGraph.prototype.fireMouseEvent = function(evtName, me, source) {
		...
		if (!false && evtName == mxEvent.MOUSE_DOWN
		...
		if (!me.isConsumed() && this.isEnabled() && this.graph.isEnabled()
			...
			if (this.previous != null && this.start != null) {
				...
				if (state != null && this.error == null) {
					...
					state.shape.node.style.cursor = (false)
							? 'all-scroll'
							: 'default';
...

{
	...
	mxEditor.prototype.showProperties = function(cell) {
		...
		if (cell != null) {
			...
			if(tagName == "Workflow") {
				window.showModalDialog("workflow/index.jsp",window,"dialogHeight:558px;dialogWidth:505px;dialogLeft:250px;dialogTop:180px;edge:raised;scroll:1;status:0;help:0;resizable:0;");			
				return ;
			} else if(tagName == "task") {
				window.showModalDialog("taskProperty/index.jsp",window,'dialogHeight:520px;dialogWidth:505px;dialogLeft:250px;dialogTop:200px;edge:raised;scroll:1;status:0;help:0;resizable:0;');			
				return ;
			} else if(tagName == "Edge") {
				window.showModalDialog("connect/index.jsp",window,'dialogHeight:450px;dialogWidth:550px;dialogLeft:250px;dialogTop:200px;edge:raised;scroll:1;status:0;help:0;resizable:1;');
				return ;
			}
	...
	mxCodec.prototype.encode = function(obj) {
		...
		if (obj != null && obj.constructor != null) {
			...
			if (enc != null) {
				...
				if (isNode(obj)) {
					node = (false) ? obj.value.cloneNode(true) : this.document
		...
		.register(function() {
			...
			codec.afterEncode = function(enc, obj, node) {
				if (obj.value != null
					...
					var tmp = node;
					node = (false) ? obj.value.cloneNode(true) : enc.document
							.importNode(obj.value, true);
		...
		while (tmp != null) {
			if (tmp.nodeName == 'add') {
				...
				if (elt != null) {
					...
					element.style.cssText = style;
					var wnd = new mxWindow(mxResources.get(as) || as, element,
