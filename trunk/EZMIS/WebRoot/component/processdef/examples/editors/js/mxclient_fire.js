...
if(self.isContainerEvent(evt)&&((!false&&!false&&!false&&!false)||!self.isScrollEvent(evt)))
{
...
icon.node.style.cursor=(false)?'all-scroll':'pointer';
...
if(isNode(obj))
{
node=(false)?obj.value.cloneNode(true):
