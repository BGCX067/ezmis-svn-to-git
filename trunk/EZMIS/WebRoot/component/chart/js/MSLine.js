...
//			autoHeight : true,
	...
	MSLine.superclass.constructor.call(this, config);

	var chart1 = new FusionCharts(contextPath+"/component/chart/Charts/MSLine.swf", "chart1Id", document.body.offsetWidth-10, document.body.offsetHeight-230);
...
Ext.extend(MSLine, Ext.Viewport, {
