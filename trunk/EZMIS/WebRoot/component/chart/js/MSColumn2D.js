MSColumn2D = function(config,param) {
	var cfg = {
		layout : 'border',
...
//			autoHeight : true,
	...
	MSColumn2D.superclass.constructor.call(this, config);

	var chart1 = new FusionCharts(contextPath+"/component/chart/Charts/MSColumn2D.swf", "chart1Id", document.body.offsetWidth-10, document.body.offsetHeight-210);
...
Ext.extend(MSColumn2D, Ext.Viewport, {
