...
Data2 = function(config, param) {
	...
	Data2.superclass.constructor.call(this, config);
	...
	var chart3 = new FusionCharts(contextPath + "/component/chart/Charts/Column2D.swf", "chart1Id",document.body.offsetWidth / 2 - 15, document.body.offsetHeight / 2 - 15);
