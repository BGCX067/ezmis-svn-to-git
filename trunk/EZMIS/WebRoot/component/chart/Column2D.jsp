...
<html>
  ...
  <body scroll="no" id="index">
	...
	<script type="text/javascript" src="${contextPath}/component/chart/js/Column2D.js" charset="UTF-8"></script>
...
<script type="text/javascript">
	...
	*--------------- GetResult(str) ----------------- */
	    ...
	    oBao.open("POST",link1 + "?year="+str,false);
	...
	function BuildSel(str,sel){	
		...
		var chart1 = new FusionCharts(contextPath+"/component/chart/Charts/Column2D.swf", "chart1Id", document.body.offsetWidth-10, document.body.offsetHeight-180);
	...
	<!-- 入口程序 -->
		...
		Ext.onReady(function(){
			...
			var column2d = new Column2D({},{dataXml:oXML.xml,table:table,years:years});
			column2d.render('center');
