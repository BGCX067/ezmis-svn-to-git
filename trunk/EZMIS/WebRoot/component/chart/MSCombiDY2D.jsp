...
<html>
  ...
  <body scroll="no" id="index">
	...
	<script type="text/javascript" src="${contextPath}/component/chart/js/MSCombiDY2D.js" charset="UTF-8"></script>
...
<script type="text/javascript">
	...
	*--------------- GetResult(str) ----------------- */
	    ...
	    oBao.open("POST",link6 + "?year="+str,false);
	...
	function BuildSel(str,sel){	
		...
		var chart1 = new FusionCharts(contextPath+"/component/chart/Charts/MSCombiDY2D.swf", "chart1Id", document.body.offsetWidth-10, document.body.offsetHeight-220);
	...
	<!-- 入口程序 -->
		...
		Ext.onReady(function(){
			...
			var mscombidy2d = new MSCombiDY2D({},{dataXml:oXML.xml,table:table,years:years});
			mscombidy2d.render('center');
