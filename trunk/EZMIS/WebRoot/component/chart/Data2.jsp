...
<html>
  <head>
	...
	function GetResultA(str){
	    ...
	    oBao.open("POST",link10 + "?year="+str,false);
	    oBao.send();
	...
	function HandleA(str){	
		...
		var chart1 = new FusionCharts(contextPath + "/component/chart/Charts/Column2D.swf", "chart1Id", document.body.offsetWidth / 2 - 15, document.body.offsetHeight / 2 - 15);
		chart1.setDataXML(oXML1.xml);
		chart1.setTransparent(true);
		chart1.render("two");
		
		var chart2 = new FusionCharts(contextPath + "/component/chart/Charts/Column2D.swf", "chart1Id", document.body.offsetWidth / 2 - 15, document.body.offsetHeight / 2 - 15);
	...
	function GetResultB(str1,str2){
	    var oBao = new ActiveXObject("Microsoft.XMLHTTP");
	    oBao.open("POST",link11 + "?year="+str1 + "&month=" + str2,false);
	    oBao.send();
	...
	function GetResultC(str1,str2,str3){
	    var oBao = new ActiveXObject("Microsoft.XMLHTTP");
	    oBao.open("POST",link12 + "?year="+str1+"&month="+str2+"&day="+str3,false);
	    oBao.send();
  ...
  <body scroll="no">
	...
	<script type="text/javascript" src="${contextPath}/component/chart/js/Data2.js" charset="UTF-8"></script>
...
<script type="text/javascript">
	...
	<!-- 入口程序 -->
		...
		Ext.onReady(function(){
			...
			var data2 = new Data2({},{dataXml1:oXML1,dataXml2:oXML2,dataXml3:oXML3,table:table,title:title});
			data2.render('center');
