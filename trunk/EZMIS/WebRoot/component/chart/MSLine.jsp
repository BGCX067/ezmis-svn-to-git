...
<script type="text/javascript">
	...
	*--------------- GetResult(str) ----------------- */
	    ...
	    oBao.open("POST",link5 + "?year="+str,false);
	...
	function BuildSel(str,sel){	
		...
		var chart1 = new FusionCharts(contextPath+"/component/chart/Charts/MSLine.swf", "chart1Id", document.body.offsetWidth-10, document.body.offsetHeight-220);
	...
	<!-- 入口程序 -->
		...
		Ext.onReady(function(){
			...
			var msline = new MSLine({},{dataXml:oXML.xml,table:table,years:years});
			msline.render('center');
