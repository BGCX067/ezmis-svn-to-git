...
Components = {
	...
	getComponents : function() {
		...
		data.push(
			...
			['表单,面板','FormPanel 表单面板',
				'可容纳表单控件的面板',
				{xtype:'form',title:'Form'}]
			);

		// Tab Panel
		data.push(['面板', 'TabPanel 标签面板', 'A panel with many tabs', function(add,parent) {
		...
		// Accordion Layout
		data.push(['布局', 'Accordion 手风琴布局', 'Layout as accordion', function(add,parent) {
			var w = new Ext.Window({
		...
		// Table Layout
		data.push(['布局', 'Table表格布局', 'Layout as a table', function(add,parent) {
			var w = new Ext.Window({
        width:300,
        height:300,
        layout:"fit",
		...
		// Column Layout
		data.push(['布局', 'Column列布局', 'Layout of columns', function(add,parent) {
			var w = new Ext.Window({
        width:425,
        height:349,
        layout:"fit",
		...
		// Border layout
		data.push(['布局','Border边框布局', 'Layout with regions', function(add,parent) {
				var w = new Ext.Window({
					title:"Border Layout",
					width:550,
					height:400,
