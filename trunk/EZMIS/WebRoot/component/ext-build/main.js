...
Main.prototype = {
					...
					tbar    : [{
							...
							handler : function() {
								Ext.Msg.alert('Informations',
									...
									'Source : <a href="main.js">main.js</a> <a href="components.js">components.js</a> <a href="cfg.js">cfg.js</a>');
							}
						}
					]
				},
	...
	initComponentsPanel : function() {
		...
		var data = Components.getComponents();
...
Ext.apply(fields, {
	...
	x                : {desc:"X position in pixels (for absolute layouts",type:"number"},
	y                : {desc:"Y position in pixels (for absolute layouts",type:"number"},
