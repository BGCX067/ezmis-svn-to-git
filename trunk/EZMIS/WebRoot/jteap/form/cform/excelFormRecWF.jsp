...
<html>
	<head>
		...
		<%
			...
			String cformId=request.getParameter("formId");
	...
	<body onload="onload();window.parent.document.getElementById('toolbar').focus();" onresize="windowResize();">
		<div id="bgDiv">
