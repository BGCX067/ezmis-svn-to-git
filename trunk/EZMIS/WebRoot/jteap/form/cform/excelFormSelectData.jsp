...
<html>
  ...
  <body scroll="no">
	...
	<script>
		...
		//请求表定义树形结构
		var link2="${contextPath}/jteap/dbdef/DefTableInfoAction!showTreeAction.do";
	...
	<script type="text/javascript" src="script/excelFormSelectData.js" charset="UTF-8"></script>
