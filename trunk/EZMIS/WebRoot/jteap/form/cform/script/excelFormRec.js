...
var data2dRecJson = {}; // 业务数据记录json数据对象
var dictRecJson = {}; // 行指标记录json数据对象
var rowZbCell = "";//行指标开始单元格
var formType = "";//表单类型
var rowZbRowNum = 0;//记录行指标开始行号
var rowZbColNum = 0;//记录行指标开始列号
var InputsDataArray = [];//数据数据集合集合
var InputsData = ""
