...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="onload();" onresize="">
		...
		<div id="toolBar" style="height:550px;width:${eform.width}px;overflow-y:auto;overflow-x:auto;">
			<iframe id='eformFrame' onload="" src="#" height="200px" width="100%" frameborder="no"></iframe>
		</div>
	</body>
</html>
