...
//		TANGER_OCX_OBJ.BeginOpenFromURL("ReadDocServlet?templateId=" + docid);
		TANGER_OCX_OBJ.OpenFromURL(url,null,"Excel.Sheet");
	}
	else
	{
 ...
 * 发布Html文件
 */
function TANGER_OCX_SaveAsHTMLToPublishPath(fileName)
{
