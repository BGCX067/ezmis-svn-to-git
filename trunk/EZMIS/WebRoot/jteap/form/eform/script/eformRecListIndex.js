...
var mainToolbar = new Ext.Toolbar({height:26,
	items:[
		{disabled:false,id:'btnAdd',text:'新增',cls: 'x-btn-text-icon',icon:'icon/icon_1.gif',listeners:{click:btnAdd_Click}},
		{disabled:true,id:'btnModify',text:'修改',cls: 'x-btn-text-icon',icon:'icon/icon_3.gif',listeners:{click:btnModify_Click}},
		{disabled:true,id:'btnDel',text:'删除',cls: 'x-btn-text-icon',icon:'icon/icon_2.gif',listeners:{click:btnDel_Click}}
		]
});
