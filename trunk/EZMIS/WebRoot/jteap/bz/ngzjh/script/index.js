...
function btnAdd_Click(){
	...
	//showIFModule(url,"年工作计划","true",530,500,{},null,null,null,false,"auto");
...
var searchAllFs="年份#nf#dateField,计划内容#jhnr#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="年份#nf#dateField,计划内容#jhnr#textField,填写人#txr#textField".split(',');
