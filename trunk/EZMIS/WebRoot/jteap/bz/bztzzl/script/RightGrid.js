...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		//showIFModule(url,"班组通知专栏","true",600,600,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		      {id:'yxdw',header: "通知标题", width: 150, sortable: true, dataIndex: 'TZBT'},
		      {id:'yxtm',header: "通知内容", width: 250, sortable: true, dataIndex: 'TZNR'},
