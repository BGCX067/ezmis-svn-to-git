...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		new $FW({url:url,id:select.json.ID}).show();	//非模式对话框
		//showIFModule(url,"安全风险承保责任书","true",600,510,{},null,null,null,false,"auto");
	});
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		      ...
		      {id:'bt',header: "标题", width: 250, sortable: true, dataIndex: 'BT'},
        	  {id:'txr',header: "填写人", width: 120, sortable: true, dataIndex: 'TXR'},
        	  {id:'scsj',header: "上传时间", width: 120, sortable: true, dataIndex: 'SCSJ',renderer: function(value){
