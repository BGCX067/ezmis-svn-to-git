...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		if(select!=null){
			...
			//showIFModule(url,"春秋季安全大检查总结","true",550,500,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		      {id:'nf',header: "工作年份", width: 80, sortable: true, dataIndex: 'NF'},
		      {id:'jj',header: "季度", width: 80, sortable: true, dataIndex: 'JJ'},
        	  {id:'zj',header: "总结", width: 320, sortable: true, dataIndex: 'ZJ'},
        	  {id:'bz',header: "班组", width: 120, sortable: true, dataIndex: 'BZ'},
        	  {id:'txr',header: "填写人", width: 90, sortable: true, dataIndex: 'TXR'},
