...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		if(select!=null){	
			...
			//showIFModule(url,"年度培训计划","true",550,510,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		      {id:'nf',header: "工作年份", width: 150, sortable: true, dataIndex: 'NF'},
		      {id:'pxjh1',header: "培训计划", width: 250, sortable: true, dataIndex: 'PXJHCLOB'},
		      {id:'bz',header: "班组", width: 150, sortable: true, dataIndex: 'BZ'},
		      {id:'txr',header: "填写人", width: 120, sortable: true, dataIndex: 'TXR'},
		      {id:'scsj',header: "创建时间", width: 120, sortable: true, dataIndex: 'SCSJ',renderer: function(value){
