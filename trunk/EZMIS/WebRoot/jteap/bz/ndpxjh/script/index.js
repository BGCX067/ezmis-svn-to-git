...
var searchAllFs="年份#nf#dateField,培训计划#pxjh#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="年份#nf#dateField,培训计划#pxjh#textField,填写人#txr#textField".split(',');
