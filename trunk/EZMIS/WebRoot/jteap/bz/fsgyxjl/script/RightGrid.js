...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		if(select!=null){
			...
			//showIFModule(url,"反事故演习记录","true",600,600,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		      {id:'yxdw',header: "演习单位", width: 150, sortable: true, dataIndex: 'YXDW'},
		      {id:'yxtm',header: "演习题目", width: 250, sortable: true, dataIndex: 'YXTM'},
		      {id:'bz',header: "班组", width: 150, sortable: true, dataIndex: 'BZ'},
		      {id:'txr',header: "填写人", width: 120, sortable: true, dataIndex: 'TXR'},
        	  {id:'yxqssj',header: "演习起始日期", width: 120, sortable: true, dataIndex: 'YXQSSJ'}
			]);
		return cm;
	},
	/**
