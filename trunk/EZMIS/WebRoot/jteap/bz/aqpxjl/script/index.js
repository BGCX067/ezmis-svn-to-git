...
var searchAllFs="上传时间#SCSJ#dateField,培训主题#pxzt#textField,举办单位#jbdw#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="上传时间#SCSJ#dateField,培训主题#pxzt#textField,举办单位#jbdw#textField".split(',');
