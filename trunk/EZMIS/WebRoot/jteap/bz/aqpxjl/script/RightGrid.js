...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		if(select!=null){
			...
			//showIFModule(url,"安全培训记录","true",570,460,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		      {id:'pxzt',header: "培训主题", width: 200, sortable: true, dataIndex: 'PXZT'},
        	  {id:'pxnr',header: "培训内容", width: 220, sortable: true, dataIndex: 'PXNR'},
        	  {id:'jbdw',header: "举办单位", width: 100, sortable: true, dataIndex: 'JBDW'},
        	  {id:'kssj',header: "开始时间", width: 120, sortable: true, dataIndex: 'KSSJ'},
        	  {id:'jssj',header: "结束时间", width: 120, sortable: true, dataIndex: 'JSSJ'}
			]);
		return cm;
	},
	/**
