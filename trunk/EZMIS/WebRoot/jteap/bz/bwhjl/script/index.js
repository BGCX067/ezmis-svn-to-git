...
function btnAdd_Click(){
	...
	//showIFModule(url,"班委会记录","true",585,695,{},null,null,null,false,"auto");
...
var searchAllFs="时间#sj#dateField,会议主题#hyzt#comboBox,会议议题#hyyt#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="时间#sj#dateField,会议主题#hyzt#comboBox,会议议题#hyyt#textField".split(',');
