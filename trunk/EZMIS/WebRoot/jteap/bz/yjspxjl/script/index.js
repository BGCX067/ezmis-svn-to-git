...
function btnAdd_Click(){
	...
	//showIFModule(url,"月技术培训记录","true",580,600,{},null,null,null,false,"auto");
...
var searchAllFs="讲课时间#JKSJ#dateField,讲课题目#jktm#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="讲课时间#JKSJ#dateField,讲课题目#jktm#textField,填写人#txr#textField".split(',');
