...
function btnAdd_Click(){
	...
	//showIFModule(url,"事故预想记录","true",585,580,{},null,null,null,false,"auto");
...
var searchAllFs="填写日期#RQ#dateField,班组#bz#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="填写日期#RQ#dateField,班组#bz#textField,填写人#txr#textField".split(',');
