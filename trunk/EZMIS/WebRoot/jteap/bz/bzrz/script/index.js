...
function btnAdd_Click(){
	...
	//showIFModule(url,"班长日志","true",700,600,{},null,null,null,false,"auto");
...
var searchAllFs="时间#SJ#dateField,班组#bz#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="时间#SJ#dateField,班组#bz#textField,填写人#txr#textField".split(',');
