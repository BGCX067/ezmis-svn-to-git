...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		if(select!=null){
			...
			//showIFModule(url,"重点工作总结","true",530,530,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		      ...
		      {id:'zt',header: "主题", width: 200, sortable: true, dataIndex: 'ZT'},        	 
        	  {id:'zjnr',header: "总结内容", width: 285, sortable: true, dataIndex: 'ZJNR'},
        	  {id:'txr',header: "填写人", width: 100, sortable: true, dataIndex: 'TXR'},
        	  {id:'sj',header: "年份", width: 80, sortable: true, dataIndex: 'NF'},
        	  {id:'scsj',header: "创建时间", width: 100, sortable: true, dataIndex: 'SCSJ',renderer: function(value){
