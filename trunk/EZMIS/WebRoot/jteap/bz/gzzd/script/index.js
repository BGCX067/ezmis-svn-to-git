...
function btnAdd_Click(){
	...
	//showIFModule(url,"规章制度","true",550,510,{},null,null,null,false,"auto");
...
var searchAllFs="上传时间#SCSJ#dateField,制度名#zdm#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="上传时间#SCSJ#dateField,制度名#zdm#textField,填写人#txr#textField".split(',');
