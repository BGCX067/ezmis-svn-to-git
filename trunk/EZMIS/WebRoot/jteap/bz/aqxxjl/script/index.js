...
var searchAllFs="日期#RQ#dateField,安全措施#aqcs#textField,填写人#txr#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="日期#RQ#dateField,安全措施#aqcs#textField,填写人#txr#textField".split(',');
var searchPanel=new SearchPanel({region:'north',searchDefaultFs:searchDefaultFs,searchAllFs:searchDefaultFs,labelWidth:80});
