...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		//showIFModule(url,"安全学习记录","true",580,600,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		      {id:'aqxxnr',header: "安全学习内容", width: 200, sortable: true, dataIndex: 'AQXXNR'},
        	  {id:'aqcs',header: "安全措施", width: 200, sortable: true, dataIndex: 'AQCS'},
        	  {id:'fcldjcqm',header: "分厂领导检查签名", width: 120, sortable: true, dataIndex: 'FCLDJCQM'},
        	  {id:'txr',header: "填写人", width: 120, sortable: true, dataIndex: 'TXR'},
        	  {id:'scsj',header: "日期", width: 120, sortable: true, dataIndex: 'RQ',renderer: function(value){
