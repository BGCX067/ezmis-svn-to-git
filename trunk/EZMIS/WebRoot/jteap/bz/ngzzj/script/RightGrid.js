...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		if(select!=null){
			...
			//showIFModule(url,"年工作总结","true",530,500,{},null,null,null,false,"auto");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
        	  ...
        	  {id:'zjnr',header: "总结内容", width: 300, sortable: true, dataIndex: 'ZJNR'},
        	  {id:'txr',header: "填写人", width: 120, sortable: true, dataIndex: 'TXR'},
        	  {id:'nf',header: "工作年份", width: 90, sortable: true, dataIndex: 'NF'},
        	  {id:'scsj',header: "创建时间", width: 110, sortable: true, dataIndex: 'SCSJ',renderer: function(value){
