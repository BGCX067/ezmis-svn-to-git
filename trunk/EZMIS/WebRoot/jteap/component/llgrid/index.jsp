...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="${contextPath}/script/ext-extend/llgrid/LiveLockGrid.css" />
  </head>
  ...
  <body scroll="no">
	...
	<script type="text/javascript" src="${contextPath}/script/ext-extend/livegrid/build/livegrid-all-debug.js"></script>
	<script type="text/javascript" src="${contextPath}/script/ext-extend/llgrid/LiveLockGrid.js"></script>
	
	<script type="text/javascript" src="${contextPath}/script/date.js"></script>
	<script type="text/javascript" src="script/RightLiveGrid.js" charset="UTF-8"></script>
