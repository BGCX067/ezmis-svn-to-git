...
var searchAllFs="报废单编号#bh#textField,报废时间起始#bfStart#dateField,报废时间终止#bfEnd#dateField,核算人员#hsry#persons,处理人员#clry#persons,主管#zg#persons,厂领导#cld#persons".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="报废单编号#bh#textField,报废时间起始#bfStart#dateField,报废时间终止#bfEnd#dateField,核算人员#hsry#persons,处理人员#clry#persons,主管#zg#persons,厂领导#cld#persons".split(",");
