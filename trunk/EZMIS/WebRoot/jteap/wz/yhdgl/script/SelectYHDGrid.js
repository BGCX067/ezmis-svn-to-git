 ...
 */
RightGrid=function(){
    var defaultDs=this.getDefaultDS(link9+"?bljhsqid="+docid+"&type="+type+"&zt="+zt);
    var grid=this;
	...
	this.on("cellclick",function(grid, rowIndex, columnIndex, e){
		...
		var whereSql = "obj.yhdgl.id ='" + yhdid +"' and obj.cgjhmx.xqjhmx is null ";
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'ghdw',header: "供货单位", hidden:true,width: 100, sortable: true, dataIndex: 'ghdw'},
...
mxRightGrid=function(){
    var defaultDs=this.getDefaultDS(link10);
    var grid=this;
//    this.pageToolbar=new Ext.PagingToolbar({
//	    pageSize: CONSTANTS_PAGE_DEFAULT_LIMIT,
//	    store: defaultDs,
...
Ext.extend(mxRightGrid, Ext.grid.EditorGridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			'sxsl','ghdw','xh','sl','zf','wzdagl','wzdagl.kw',"wzdagl.xhgg",'wzdagl.kw.cwmc','wzdagl.kw.ck','wzdagl.kw.ck.id','wzdagl.kw.ck.ckmc','wzdagl.wzmc','yhdgl','yhdgl.bh','yhdgl.bz','yhdgl.gclb','yhdgl.gcmx','tssl','fpbh','dhsl','cgjldw','sqdj','yssl','id','jhdj','hsxs'
	        ]),
	        remoteSort: true
	    });
		return ds;
