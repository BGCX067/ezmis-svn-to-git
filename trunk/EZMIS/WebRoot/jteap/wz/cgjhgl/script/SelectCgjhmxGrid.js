 ...
 */
RightGrid=function(){
    var defaultDs=this.getDefaultDS(link10 + "&cgy="+cgy+"&bh="+bh);
    var grid=this;
...
//		}},'-','<font color="red"></font>']
	...
	this.on("cellclick",function(grid, rowIndex, columnIndex, e){
		...
		var whereSql = "obj.cgjhgl.id ='" + jhid +"' and obj.cgy='"+cgy+"'";
		mxGrid.store.baseParams={PAGE_FLAG:'PAGE_FLAG_NO',queryParamsSql:whereSql,zt:1};
		mxGrid.store.load({callback:function(r,options,success){
			var mxstore = mxGrid.store;
			var ids ="";
