 ...
 */
xqjhSqGrid=function(){
    var defaultDs=this.getDefaultDS(link12);
    var grid=this;
...
//		}},'-','<font color="red"></font>']
	...
	xqjhSqGrid.superclass.constructor.call(this,{
	 	ds: defaultDs,
	...
	this.on("cellclick",function(grid, rowIndex, columnIndex, e){
		var jhid = xqjhSqGrid.store.data.items[rowIndex].id;
...
Ext.extend(xqjhSqGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'XQJHSQBH',header: "需求计划申请编号", width: 100, sortable: true, dataIndex: 'XQJHSQBH'},
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				...
				{id:'xqjhsq.gcxm',header: "工程项目", width: 80, sortable: true, dataIndex: 'xqjhsq.gcxm'},
