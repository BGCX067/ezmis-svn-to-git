...
RightGrid=function(){
	...
	this.on("cellclick",function(grid, rowIndex, columnIndex, e){
		...
		var whereSql = "obj.fjcld.id ='" + jhid +"'";
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				{id:'bh',header: "处理单单编号", width: 100, sortable: true, dataIndex: 'bh'},
				{id:'bm',header: "处理部门", width: 100, sortable: true, dataIndex: 'bm'},
				{id:'zwy',header: "业务员", width: 100, sortable: true, dataIndex: 'zwy'},
				{id:'zg',header: "主管", width: 100, sortable: true, dataIndex: 'zg'},
				{id:'czr',header: "操作员", width: 100, sortable: true, dataIndex: 'czr'},
				{id:'clrq',header: "处理日期", width: 150, sortable: true, dataIndex: 'clrq',
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				...
				{id:'wzlb',header: "物资类别", width: 180, sortable: true, dataIndex: 'wzlb',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						var list = $dictListAjax("BFWZLB");
				...
				{id:'sl',header: "数量", width: 100, sortable: true,align:'right', dataIndex: 'sl',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						if(!value || value==''){
							value = 0;
						}
				...
				{id:'cldj',header: "处理单价", width: 100, sortable: true,align:'right', dataIndex: 'cldj',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						if(!value || value==''){
							value = 0;
						}
