...
var searchAllFs="编号#bh#textField,发放时间#ffsj#dateField,到期时间#dqsj#dateField,物资#wzbm.wzmc#wzdagl,职工#zgxm#persons,主管#zg#persons,操作员#czr#persons,发料人#flr#persons".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="编号#bh#textField,发放时间#ffsj#dateField,到期时间#dqsj#dateField,物资#wzbm.wzmc#wzdagl,职工#zgxm#persons,主管#zg#persons,操作员#czr#persons,发料人#flr#persons".split(",");
