var SearchPanel = function(config){
	...
	this.searchClick=function(){
		...
		var hasSearchCondition = false;
	 	...
	 	var url=link4;
	 	if(hasSearchCondition) url=link4.split('?')[0]+"?queryParamsSql=obj.grgyqf='2' and "+queryParamsSql.substring(0,queryParamsSql.length-5);
...
Ext.extend(SearchPanel, Ext.app.SearchPanel, {
		...
		if (sType == "textField") { // 文本类型
			...
			oSearchField = new Ext.app.TriggerField({
				...
				onTriggerClick:function(){
					var field = this;
				   var url = contextPath+"/jteap/wz/grgqjtz/groupSelect.jsp";
				   var result = showModule2(url, true, 300, 500,{});
