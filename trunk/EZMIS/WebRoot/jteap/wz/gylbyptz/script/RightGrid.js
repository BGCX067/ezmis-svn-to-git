...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	...
		    	{id:'bm',header: "部门", width: 70, sortable: true, dataIndex: 'bm'},
		    	{id:'wzbm.wzmc',header: "物资名称", width: 120, sortable: true, dataIndex: 'wzbm.wzmc'},
		    	{id:'ffsj',header: "发放时间", width: 90, sortable: true, dataIndex: 'ffsj',
				    renderer:function(value,metadata,record,rowIndex,colIndex,store){
						var dt = formatDate(new Date(value["time"]),"yyyy-MM-dd"); 
						return dt;         
					}},
				{id:'dqsj',header: "到期时间", width: 90, sortable: true, dataIndex: 'dqsj',
				    renderer:function(value,metadata,record,rowIndex,colIndex,store){
						var dt = formatDate(new Date(value["time"]),"yyyy-MM-dd"); 
						return dt;         
					}},
...
//				{id:'sjc',header: "生计处", width: 70, sortable: true, dataIndex: 'sjc'},
				...
				{id:'llr',header: "领料人", width: 70, sortable: true, dataIndex: 'llr'},
