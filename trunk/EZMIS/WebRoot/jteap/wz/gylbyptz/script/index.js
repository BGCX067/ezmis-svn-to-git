...
function btnAdd_Click(){
	var result=showModule(link6,true,584,290);
...
function btnModify_Click(){
	...
	if(select){
		...
		result=showModule(url,true,584,290,params);
		rightGrid.getStore().reload();
	}
}
...
var searchAllFs="编号#bh#textField,发放时间#ffsj#dateField,到期时间#dqsj#dateField,物资#wzbm.wzmc#wzdagl,部门#bm#group,主管#zg#persons,操作员#czr#persons,发料人#flr#persons,领料人#llr#persons".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="编号#bh#textField,发放时间#ffsj#dateField,到期时间#dqsj#dateField,物资#wzbm.wzmc#wzdagl,部门#bm#group,主管#zg#persons,操作员#czr#persons,发料人#flr#persons,领料人#llr#persons".split(",");
