<!-- 当前模块所有具有权限的操作 -->
<jteap:operations/>
<jteap:dict catalog="CKRZLB"></jteap:dict>
<script>
	//分类树
	...
	//列表
	var link4="${contextPath}/jteap/wz/crkrzgl/CrkrzglAction!showListAction.do?queryParamsSql=obj.crkqf='2'";
	...
	var link15="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YCRKRZ_CK_VIEW";
