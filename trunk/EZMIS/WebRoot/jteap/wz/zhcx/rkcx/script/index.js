...
var searchAllFs="入库单编号#crkdh#textField,入库时间起#dtStart#dateField,入库时间止#dtEnd#dateField,入库类别#crklb#comboRkrzlb,入库仓库#ckbh#comboCkgl,操作人#czrxm#Czr".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="入库单编号#crkdh#textField,入库时间起#dtStart#dateField,入库时间止#dtEnd#dateField,入库类别#crklb#comboRkrzlb,入库仓库#ckbh#comboCkgl,操作人#czrxm#Czr".split(",");
var searchPanel=new SearchPanel({searchDefaultFs:searchDefaultFs,searchAllFs:searchAllFs,title:'入库日志查询',labelWidth:80});
