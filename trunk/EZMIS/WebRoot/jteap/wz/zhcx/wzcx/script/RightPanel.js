...
var searchAllFs=["物资名称#wzmc#wzdagl","助记码#zjm#textField","物资编码#wzbh#textField","仓库#kw.ckid#comboCkgl","库存#dqkc#comboKc"];
//查询面板中默认显示的条件，格式同上
var searchDefaultFs=["物资名称#wzmc#wzdagl","助记码#zjm#textField","物资编码#wzbh#textField","仓库#kw.ckid#comboCkgl","库存#dqkc#comboKc"];
