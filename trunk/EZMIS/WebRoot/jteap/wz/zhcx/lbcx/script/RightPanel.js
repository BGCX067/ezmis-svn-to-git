...
var searchAllFs=["物资名称#wzmc#textField","型号规格#xhgg#textField","仓库#kw.ckid#comboCkgl"];//,"仓库#kw.ckid#comboCkgl"
//查询面板中默认显示的条件，格式同上
var searchDefaultFs=["物资名称#wzmc#textField","型号规格#xhgg#textField","仓库#kw.ckid#comboCkgl"];//,"仓库#kw.ckid#comboCkgl"
