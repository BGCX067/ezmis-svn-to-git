...
RightGrid=function(){
    ...
    var defaultDs=this.getDefaultDS(link1+"?queryParamsSql=obj.xqjhqf='1' and (obj.dyszt !='0' and obj.dyszt !=null)&limit=100");
    defaultDs.load();
    var grid=this;
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    ...
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'flowStatus',header: "需求申请状态", width: 130, sortable: true, dataIndex: 'flowStatus',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
					 	if(value != ''){
