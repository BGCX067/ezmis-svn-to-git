...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	...
		    	{id:'zgxm',header: "职工", width: 70, sortable: true, dataIndex: 'zgxm'},
				...
				{id:'dj',header: "单价", width: 70, sortable: true,align:'right', dataIndex: 'dj',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						if(!value || value==''){
							value = 0;
						}
				...
				{id:'zje',header: "总金额", width: 70, sortable: true,align:'right', dataIndex: 'zje',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						if(!value || value==''){
							value = 0;
						}
