...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		    	{id:'bh',header: "税率编码", width: 100, sortable: true, dataIndex: 'bh'},
		    	{id:'c_name',header: "账本名称", width: 150, sortable: true, dataIndex: 'c_name'},
				{id:'n_value',header: "税率", width: 100, sortable: true, dataIndex: 'n_value',align:'right'}
