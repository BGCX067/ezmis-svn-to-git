...
var SearchPanel = function(config){
	...
	this.searchClick=function(){
		...
		var queryParamsSql = "";
	 	...
	 	if(queryParamsSql.substring(0,queryParamsSql.length-5) == ""){
	 		if(wzmc != ""){
		 		url = link1+"?queryParamsSql=obj.xqjhqf='2'&limit=100&wzmc="+wzmc+"";
	 		}else{
	 			url = link1+"?queryParamsSql=obj.xqjhqf='2'&limit=100";
	 		}
	 	}else{
	 		url = link1+"?queryParamsSql=obj.xqjhqf='2' and "+queryParamsSql.substring(0,queryParamsSql.length-5)+"&limit=100&wzmc="+wzmc+"";
	 	}
	...
	this.clearSearch=function(){
		...
		var oItems = oPanel.items.items;
 		...
 		var url = link1+"?queryParamsSql=obj.xqjhqf='2'"+"&limit=100";
 		rightGrid.changeToListDS(url);
 		rightGrid.getStore().reload();
	};
