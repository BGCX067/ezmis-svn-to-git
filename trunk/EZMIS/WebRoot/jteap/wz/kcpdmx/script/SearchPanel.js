	 		...
	 		if(oItem.hidden==false){
	 			...
	 			if(tempValue!=null&&tempValue!=""){
		 			...
		 			if(temp.triggerClass=="x-form-date-trigger"){
		 				...
		 				}else if(temp.id.split("#")[1]=="pdStart"){
		 					sxStart = tempValue;
		 					queryParamsSql+="to_char(obj.pdd.pdsj,'yyyy-mm-dd hh24:mi')>='"+tempValue+"' and ";
		 				}else if(temp.id.split("#")[1]=="pdEnd"){
		 					queryParamsSql+="to_char(obj.pdd.pdsj,'yyyy-mm-dd hh24:mi')<='"+tempValue+"' and ";
		 					if(sxStart!=null){
...
//		 			}
		 				...
		 				queryParamsSql+="obj.wzda.kw.ckid = '"+encodeURIComponent(tempValue)+"' and ";
		 			}else if(temp.id.split("#")[1]=="bh"){
		 				queryParamsSql+="obj.pdd.bh = '"+encodeURIComponent(tempValue)+"' and ";
		 			}else{
	 					queryParamsSql+="obj."+temp.id.split("#")[1]+" like '%"+encodeURIComponent(tempValue)+"%' and ";
		 			}
	 			}
