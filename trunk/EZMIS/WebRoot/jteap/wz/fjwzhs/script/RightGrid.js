...
RightGrid=function(){
	...
	this.on("cellclick",function(grid, rowIndex, columnIndex, e){
		...
		var whereSql = "obj.fjhsd.id ='" + jhid +"'";
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				{id:'hsdh',header: "回收单单编号", width: 100, sortable: true, dataIndex: 'hsdh'},
				...
				{id:'hsrq',header: "回收日期", width: 150, sortable: true, dataIndex: 'hsrq',
