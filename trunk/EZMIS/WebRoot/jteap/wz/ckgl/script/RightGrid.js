...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			'ckgly','person','person.userName','ckbm','bz','ckmc','id'
	        ]),
	        remoteSort: true
	    });
		return ds;
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		    	{id:'ckbm',header: "仓库编码", width: 100, sortable: true, dataIndex: 'ckbm'},
		    	{id:'ckmc',header: "仓库名称", width: 200, sortable: true, dataIndex: 'ckmc'},
				{id:'ckgly',header: "仓库管理员", width: 100, sortable: true, dataIndex: 'person.userName'},
				{id:'bz',header: "备注", width: 200, sortable: true, dataIndex: 'bz'}
//				,{id:'id',header: "id", hidden:true,width: 100, sortable: true, dataIndex: 'id'}
			]);
		return cm;
	},
	/**
