...
Ext.extend(CenterPersonGrid , Ext.grid.GridPanel , {
	...
	getP2GActionColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		        ...
		        {id:'userLoginName2',header: "用户名", width: 100, sortable: true, dataIndex: 'person.userLoginName2'},
		        {id:'userLoginName',header: "工号", width: 100, sortable: true, dataIndex: 'person.userLoginName'},
				{id:'sex',header: "性别", width: 105, sortable: true, dataIndex: 'person.sex'}
				/*
	...
	getPersonActionColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		        {id:'userName',header: "昵称", width: 120, sortable: true, dataIndex: 'userName'},
		        {id:'userLoginName2',header: "用户名", width: 200, sortable: true, dataIndex: 'userLoginName2'},
		        {id:'userLoginName',header: "工号", width: 200, sortable: true, dataIndex: 'userLoginName'},
				{id:'sex',header: "性别", width: 105, sortable: true, dataIndex: 'sex'}
				/*
