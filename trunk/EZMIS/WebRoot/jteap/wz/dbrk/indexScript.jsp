...
<script>
	...
	//列表
	var link4="${contextPath}/jteap/wz/dbdgl/DbdAction!showListAction.do?zt=0&dbqf=1";
	
	//删除
	var link5="${contextPath}/jteap/wz/dbdgl/DbdAction!removeAction.do";
	
	//添加
	var link6="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YDBD";
	
	//调入单生效
	var link7="${contextPath}/jteap/wz/dbdgl/DbdAction!enableDR.do";
	...
	//修改
	var link13="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YDBD";
