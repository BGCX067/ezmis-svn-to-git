...
DrGrid=function(){
	...
	DrGrid.superclass.constructor.call(this,{
	 	ds: defaultDs,
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		var select=drGrid.getSelectionModel().getSelections()[0];
...
Ext.extend(DrGrid, Ext.grid.GridPanel, {
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				{id:'dbd.bh',header: "调入单编号", width: 100, sortable: true, dataIndex: 'dbd.bh'},
				{id:'dbd.dbsj',header: "调入时间", width: 150, sortable: true, dataIndex: 'dbd.dbsj',
				 	renderer:function(value,metadata,record,rowIndex,colIndex,store){
