...
var searchAllFs="计划员#jhy#persons,申请部门#sqbm#depts,是否作废#is_cancel#comboBox,需求申请编号#xqjhsqbh#textField,物资名称#wzda#wzdagl,型号规格#xhgg#textField".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="计划员#jhy#persons,申请部门#sqbm#depts,是否作废#is_cancel#comboBox,需求申请编号#xqjhsqbh#textField,物资名称#wzda#wzdagl,型号规格#xhgg#textField".split(",");
