...
<script>
	...
	//列表
	var link4="${contextPath}/jteap/wz/bfdgl/WzbfdAction!showListAction.do?zt=0";
	
	//删除
	var link5="${contextPath}/jteap/wz/bfdgl/WzbfdAction!removeAction.do";
	
	//添加
	var link6="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YKCBFD";
	
	//报废单生效
	var link7="${contextPath}/jteap/wz/bfdgl/WzbfdAction!enableDC.do";
	...
	//修改
	var link13="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YKCBFD";
	
	//采购计划明细列表
	var link14="${contextPath}/jteap/wz/bfdgl/WzbfdMxAction!showListAction.do";
</script>