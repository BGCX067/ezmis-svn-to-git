...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			'wzbm','crksl','id','crkjg','crkdh','xh','crkrzid'
	        ]),
	        remoteSort: true
	    });
		return ds;
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'crksl',header: "出入库数量", width: 100, sortable: true, dataIndex: 'crksl'},
				{id:'id',header: "id", width: 100, sortable: true, dataIndex: 'id'},
				{id:'crkjg',header: "出入库价格", width: 100, sortable: true, dataIndex: 'crkjg'},
				{id:'crkdh',header: "出入库单号", width: 100, sortable: true, dataIndex: 'crkdh'},
				{id:'xh',header: "序号", width: 100, sortable: true, dataIndex: 'xh'},
				{id:'crkrzid',header: "出入库日志ID", width: 100, sortable: true, dataIndex: 'crkrzid'}
			]);
		return cm;
	},
	/**
