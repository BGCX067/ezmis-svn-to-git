...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			'id','czr','crksj','crkqf','crkdh','ckbh','crklb','xgdjbh'
	        ]),
	        remoteSort: true
	    });
		return ds;
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'crksj',header: "出入库时间", width: 100, sortable: true, dataIndex: 'crksj',
				    renderer:function(value,metadata,record,rowIndex,colIndex,store){
						var dt = formatDate(new Date(value["time"]),"yyyy-MM-dd"); 
						return dt;         
					}},
				{id:'crkqf',header: "出入库区分", width: 100, sortable: true, dataIndex: 'crkqf'},
				{id:'crkdh',header: "出入库单号", width: 100, sortable: true, dataIndex: 'crkdh'},
				{id:'ckbh',header: "出入库编号", width: 100, sortable: true, dataIndex: 'ckbh'},
				{id:'crklb',header: "出入库类别", width: 100, sortable: true, dataIndex: 'crklb'},
