var SearchPanel = function(config){
	...
	this.searchClick=function(){
		...
		var flag = false;
	 			...
	 			if(tempValue!=null&&tempValue!=""){
		 			...
		 			if(temp.triggerClass=="x-form-date-trigger"){
		 				...
		 				if(temp.id.split("#")[1]=="zdStart"){
		 					zdStart = tempValue;
		 					queryParamsSql+="to_char(obj.cgjhgl.zdsj,'yyyy-mm-dd hh24:mi')>='"+tempValue+"' and ";
	 	...
	 	var wzlbbm = (leftTree.getSelectionModel().getSelectedNode()==null)?"":leftTree.getSelectionModel().getSelectedNode().id;
	 	var url = link4+"?wzlbbm="+wzlbbm+"&queryParamsSql="+queryParamsSql.substring(0,queryParamsSql.length-5);
