...
var searchAllFs="借料申请编号#bh#textField,状态#zt#comboBox,申请人#czyxm#textField,开始日期#startDate#dateFieldShowTime,结束日期#endDate#dateFieldShowTime".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="借料申请编号#bh#textField,状态#zt#comboBox,申请人#czyxm#textField,开始日期#startDate#dateFieldShowTime,结束日期#endDate#dateFieldShowTime".split(",");
