...
RightGrid=function(){
    ...
    var defaultDs=this.getDefaultDS(link1+"?queryParamsSql=obj.lydqf='2'"+"&limit=100");
    defaultDs.load();
    var grid=this;
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    ...
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'bh',header: "物资借料申请编号", width: 120, sortable: true, dataIndex: 'bh'},
				{id:'zt',header: "借料申请状态", width: 100, sortable: true, dataIndex: 'zt',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
					 	if(value == '0'){
