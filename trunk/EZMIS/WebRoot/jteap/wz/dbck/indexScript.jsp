...
<script>
	...
	//列表
	var link4="${contextPath}/jteap/wz/dbdgl/DbdAction!showListAction.do?zt=0&dbqf=2";
	
	//删除
	var link5="${contextPath}/jteap/wz/dbdgl/DbdAction!removeAction.do";
	
	//添加
	var link6="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YDBDCK";
	
	//调出单生效
	var link7="${contextPath}/jteap/wz/dbdgl/DbdAction!enableDC.do";
	...
	//修改
	var link13="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YDBDCK";
	
	//采购计划明细列表
	var link14="${contextPath}/jteap/wz/dbdgl/DbdMxAction!showListAction.do";
</script>