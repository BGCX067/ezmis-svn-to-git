...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
	        ...
	        reader: new Ext.data.JsonReader({
	            ...
	            id: 'id'
	        }, ["id","xh","lydgl","lydgl.bh","wzbm","jldw","jhdj","pzlysl","sjlysl","zje"]),
	        remoteSort: true
	    });
		return ds;
	},
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
				{id:'xh',header: "序号", width: 100, sortable: true, dataIndex: 'jldw'},
				{id:'lydgl',header: "领用单编号", width: 100, sortable: true, dataIndex: 'lydgl.bh'},
				...
				{id:'pzlysl',header: "批准领用数量", width: 100, sortable: true, dataIndex: 'pzlysl'},
				{id:'sjlysl',header: "实际领用数量", width: 100, sortable: true, dataIndex: 'sjlysl'},
				{id:'zje',header: "总金额", width: 100, sortable: true, dataIndex: 'zje'}
			]);
		return cm;
	},
	/**
