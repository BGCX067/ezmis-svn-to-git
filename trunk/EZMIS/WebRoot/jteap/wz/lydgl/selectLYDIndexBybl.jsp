...
<html>
  ...
  <body scroll="no">
	...
	<script type="text/javascript" src="script/SelectLYDGridBybl.js" charset="UTF-8"></script>
	...
	<script type="text/javascript" src="script/SelectLYDindexBybl.js" charset="UTF-8"></script>
	<!-- 入口程序 -->
    <script type="text/javascript">
