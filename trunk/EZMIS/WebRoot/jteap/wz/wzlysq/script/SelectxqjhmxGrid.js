...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
		...
		AjaxRequest_Sync(link17, null, function(ajax){
...
Ext.extend(LyMxRightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			"XQJHMXID","XQJHBH", "WZBM", "XH","PZSL", "JLDW", "GCLB", "GCXM", "JHDJ", "FREE","CGSL","DHSL","LYSL","SLSL","PJJ","KWBM","WZMC","CKMC","DQKC","YFPSL","XHGG"
	        ]),
	        remoteSort: true
	    });
		return ds;
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				...
				{id:'PZSL',header: "批准数量", width: 80, sortable: true, dataIndex: 'PZSL'},
				{id:'PZSL',header: "已分配", width: 60, sortable: true, dataIndex: 'PZSL'},
				{id:'CGSL',header: "已采购", width: 60, sortable: true, dataIndex: 'CGSL'},
				{id:'YFPSL',header: "已分配", width: 60, sortable: true, dataIndex: 'YFPSL'},
				{id:'DHSL',header: "已到货", width: 60, sortable: true, dataIndex: 'DHSL',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
					 	return value;
					}
				},
				...
				{id:'GCLB',header: "工程类别", width: 60, sortable: true, hidden: true, dataIndex: 'GCLB'},
				{id:'GCXM',header: "工程项目", width: 60, sortable: true, hidden: true, dataIndex: 'GCXM'}
			]);
		return cm;
	},
	/**
