...
var searchAllFs="合同编号#htbh#textField,合同名称#htmc#textField,合同类型#htlx#textField".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="合同编号#htbh#textField,合同名称#htmc#textField,合同类型#htlx#textField".split(",");
