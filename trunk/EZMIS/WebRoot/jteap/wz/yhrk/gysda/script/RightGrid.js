...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
				{id:'bm',header: "供应商编码", width: 100, sortable: true, dataIndex: 'bm', hidden:true},
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				{id:'gysmc',header: "供应商名称", width: 300, sortable: true, dataIndex: 'gysmc'},
				{id:'zjm',header: "助记码", width: 100, sortable: true, dataIndex: 'zjm', hidden:true},
				{id:'dz',header: "地址", width: 100, sortable: true, dataIndex: 'dz', hidden:true},
				{id:'dh',header: "电话", width: 100, sortable: true, dataIndex: 'dh', hidden:true},
				{id:'czh',header: "传真号", width: 100, sortable: true, dataIndex: 'czh', hidden:true},
				{id:'yzbm',header: "邮政编码", width: 100, sortable: true, dataIndex: 'yzbm', hidden:true},
				{id:'lxr',header: "联系人", width: 100, sortable: true, dataIndex: 'lxr', hidden:true},
				{id:'yxdz',header: "Email", width: 100, sortable: true, dataIndex: 'yxdz', hidden:true},
//				{id:'zywz',header: "主页网址", width: 100, sortable: true, dataIndex: 'zywz'},
				{id:'frdb',header: "法人代表", width: 100, sortable: true, dataIndex: 'frdb', hidden:true},
				{id:'khyh',header: "开户银行", width: 100, sortable: true, dataIndex: 'khyh', hidden:true},
				{id:'zh',header: "账号", width: 100, sortable: true, dataIndex: 'zh', hidden:true},
				{id:'swdjh',header: "税务登记号", width: 100, sortable: true, dataIndex: 'swdjh', hidden:true}
