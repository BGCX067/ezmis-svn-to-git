...
<script>	
	...
	//导出选项卡
	var link7="${contextPath}/jteap/wz/wzda/WzdaAction!exportSelectedExcelAction.do";
	...
	//需求计划生效新物资处理
	var link11="${contextPath}/jteap/wz/wzda/WzdaAction!findWzdaActionById.do";
	
	//获取当前物资对应仓库的缺省库位编码
	var link12="${contextPath}/jteap/wz/wzlb/WzlbAction!findCwxxAction.do";
</script>