if(typeof(singleSelected) == 'undefined'){
	singleSelected = true;
}

//var columns0 = ['id','wzmc','jldw','jhdj','pjj','dqkc','je','yfpsl','dyx','zgcbde','zdcbde','wzlb.wzlbmc','abcfl','tsfl','kw.cwmc','cskc','tjm','kw.ck','kw.ck.id','kw.ck.ckmc','xhgg'];
...
RightGrid=function(){
	...
	this.getSelectionModel().on("selectionchange",function(oCheckboxSModel){
		...
		if(select && singleSelected){
			window.returnValue = select.json;
		}else if(selections && !singleSelected){
