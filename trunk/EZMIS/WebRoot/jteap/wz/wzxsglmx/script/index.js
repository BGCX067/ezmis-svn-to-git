...
var searchAllFs="销售单编号#bh#textField,购货单位#ghdw#textField,销售时间起始#xsStart#dateField,销售时间终止#xsEnd#dateField".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="销售单编号#bh#textField,购货单位#ghdw#textField,销售时间起始#xsStart#dateField,销售时间终止#xsEnd#dateField".split(",");
