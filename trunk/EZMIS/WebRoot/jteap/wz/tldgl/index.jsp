  ...
  <body scroll="no">
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var urltmp = contextPath+'/jteap/wz/cgjhmx/CgjhmxAction!showPersons.do';
			
			/*AjaxRequest_Sync(urltmp ,{},function(obj){
				var strReturn=obj.responseText;
				pList =Ext.util.JSON.decode(strReturn);
				//value = pList.list[0].userName;
				
	        });
			*/
			rightGrid.getStore().reload({callback :function(r,options,success){ 
				}});
