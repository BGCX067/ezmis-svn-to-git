...
//		items:['&nbsp;|&nbsp;','<font color="red">*双击记录查看采购明细</font>']
	...
	RightGrid.superclass.constructor.call(this,{
		...
		frame:true,
		region:'center',
		//autoExpandColumn:"tlsj",  //自动扩展宽度的列
	...
	this.on("cellclick",function(grid, rowIndex, columnIndex, e){
		...
		var whereSql = "obj.tldgl.id ='" + jhid +"'";
...
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				{id:'bh',header: "退料单编号", width: 100, sortable: true, dataIndex: 'bh'},
				{id:'tlbm',header: "退料部门", width: 100, sortable: true, dataIndex: 'tlbm'},
				...
				{id:'personTlr.userName',header: "退料人", width: 80, sortable: false, dataIndex: 'personTlr.userName',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						return value;
					}
				},
				...
				{id:'tlsj',header: "退料时间", width: 150, sortable: true, dataIndex: 'tlsj',
				    renderer:function(value,metadata,record,rowIndex,colIndex,store){
				    	if(!value) return;
...
//				{id:'jhy',header: "计划人", width: 100, sortable: true, dataIndex: 'jhy'}
	...
	enableCgjh:function(select){
		...
		var whereSql = "obj.tldgl.id in (" + idsIn.substring(0,idsIn.length-1) +")";
