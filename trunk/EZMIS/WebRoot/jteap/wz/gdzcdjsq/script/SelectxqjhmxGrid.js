...
Ext.extend(LyMxRightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			"XQJHMXID","XQJHBH", "WZBM", "XH","PZSL", "JLDW","JHDJ", "FREE","CGSL","DHSL","LYSL","SLSL","PJJ","KWBM","WZMC","CKMC","DQKC","YFPSL"
	        ]),
	        remoteSort: true
	    });
		return ds;
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	//this.sm,
//				{id:'id',header: "ID", width: 100, sortable: true, dataIndex: 'id'},
				{id:'WZMC',header: "物资", width: 100, sortable: true, dataIndex: 'WZMC'},
				...
				{id:'YFPSL',header: "已采购111", width: 80, sortable: true, dataIndex: 'YFPSL'},
