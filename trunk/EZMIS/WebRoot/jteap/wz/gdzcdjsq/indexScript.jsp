...
<script>
	//全部领用申请
	var link="${contextPath}/jteap/wz/gdzc/GdzcdjAction!showAllListAction.do";
	//草稿箱grid
	var link1="${contextPath}/jteap/wz/gdzc/GdzcdjAction!showCgxAction.do";

	// 查看当前登录人待处理的领用申请
	var link2="${contextPath}/jteap/wz/gdzc/GdzcdjAction!showDclAction.do";

	// 查看已处理领用申请
	var link3="${contextPath}/jteap/wz/gdzc/GdzcdjAction!showYclAction.do";

	// 查看作废的领用申请
	var link4="${contextPath}/jteap/wz/gdzc/GdzcdjAction!showZfAction.do";
	...
	// 作废需求计划申请单
	var link7="${contextPath}/jteap/wz/gdzc/GdzcdjAction!cancelWzlyAction.do";
