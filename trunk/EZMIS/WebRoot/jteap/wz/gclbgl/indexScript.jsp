...
<script>
	...
	//列表
	var link4="${contextPath}/jteap/wz/gclbgl/ProjcatAction!showListAction.do";
	
	//删除
	var link5="${contextPath}/jteap/wz/gclbgl/ProjcatAction!removeAction.do";
	
	//添加与修改
	var link6="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_PROJCAT";
