...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		    	{id:'projcatcode',header: "类别编码", width: 100, sortable: true, dataIndex: 'projcatcode'},
		    	{id:'projcatname',header: "类别名称", width: 150, sortable: true, dataIndex: 'projcatname'},
				{id:'memo',header: "备注", width: 300, sortable: true, dataIndex: 'memo'}
