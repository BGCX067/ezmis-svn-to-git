...
<script>
	...
	//请求指标树形结构
	var link18 = "${contextPath}/jteap/wz/gclbgl/ProjcatAction!showTreeAction.do";
	
	var link19 = "${contextPath}/jteap/wz/gcxmgl/ProjAction!getProjNodeAction.do";
	
	//添加与修改
	var link20="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_PROJ";
	
	var link21 = "${contextPath}/jteap/wz/gcxmgl/ProjAction!showTreeAction.do";
	
	//查询工程项目工作内容
	var link24 = "${contextPath}/jteap/wz/gcxmgl/ProjAction!showGznrAction.do";
