...
<script>
	...
	//列表
	var link4="${contextPath}/jteap/wz/fjhsdgl/FjhsdAction!showListAction.do?zt=1"
	
	//删除
	var link5="${contextPath}/jteap/wz/cgjhmx/CgjhmxAction!removeAction.do";
	
	//添加修改功能
	var link6="${contextPath}/jteap/form/eform/eformRec.jsp?formSn=TB_WZ_YFJWZHSD_VIEW";
