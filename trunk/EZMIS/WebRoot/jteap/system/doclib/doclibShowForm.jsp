...
<script type="text/javascript" src="${contextPath}/script/ext-extend/form/upload/UploadDialog.js" charset="UTF-8"></script>   
	...
	<script type="text/javascript" src="script/DoclibShowForm.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/AttachViewGrid.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			//alert('${param.doclibId}');
			var doclibShowForm = new DoclibShowWindow('${param.doclibId}');
			var titlePanel=new Ext.app.TitlePanel({caption:'查看文档信息',border:false,region:'north'});
			...
			doclibShowForm.show();
			doclibShowForm.loadDocData();
			doclibShowForm.loadData();   
