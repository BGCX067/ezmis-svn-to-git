...
<html>
  ...
  <body scroll="no">
	...
	<script type="text/javascript" src="script/DoclibLevelEditForm.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/DoclibLevelShowForm.js" charset="UTF-8"></script>	
