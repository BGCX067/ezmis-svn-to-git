...
RightGrid=function(){
	...
	this.getSelectionModel().on("selectionchange",function(oCheckboxSModel){
		...
		var btnDelDocument = mainToolbar.items.get('btnDelDocumentLevel');
		var btnModiDocument = mainToolbar.items.get('btnModiDocumentLevel');
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		var  doclibLevelShowWindow = new DoclibLevelShowWindow(select.get("id"));
		doclibLevelShowWindow.show();
		doclibLevelShowWindow.loadData();
	});	
}
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
		    	this.sm,
		        {id:'levelName',header: "级别名称", width: 180, sortable: true, dataIndex: 'levelName'},
		        //{id:'levelrole',header: "级别角色", width: 180, sortable: true, dataIndex: 'levelrole'},
				{id:'levelDesc',header: "级别描述", width: 180, sortable: true, dataIndex: 'levelDesc'
				/*,
