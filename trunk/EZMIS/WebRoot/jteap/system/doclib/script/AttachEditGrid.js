/**
  ...
  * **************
  **/
AttachEditGrid = function(resourceId) {
	attachGrid = this
	//被修改了得记录
	this.dirtyRecords=[];
	//默认DS
	...
	AttachEditGrid.superclass.constructor.call(this,{
		tbar : [],
		loadMask : true ,
		cm : cm ,
		store : foDefaultDS,
...
Ext.extend(AttachEditGrid , Ext.grid.EditorGridPanel , {
