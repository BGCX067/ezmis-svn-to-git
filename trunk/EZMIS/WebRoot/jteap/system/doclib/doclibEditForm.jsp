...
<script type="text/javascript" src="${contextPath}/script/ext-extend/form/upload/UploadDialog.js" charset="UTF-8"></script>  
	...
	<script type="text/javascript" src="script/DoclibEditForm.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/AttachEditGrid.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			doclibEditForm = new DoclibEditWindow('${param.catalogId}','${param.doclibId}');
			var titlePanel=new Ext.app.TitlePanel({caption:'文档信息修改',border:false,region:'north'});
