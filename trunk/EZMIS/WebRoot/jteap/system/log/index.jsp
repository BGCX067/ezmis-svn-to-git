...
<html>
  ...
  <body scroll="no" id="index">
	...
	<script type="text/javascript" src="script/DetailFormWindow.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/SearchPanel.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/LogGrid.js" charset="UTF-8"></script>
	
	<script>
		//查询面板中 所有的查询条件 格式："标签_属性名称_属性类型,标签_属性名称_属性类型,......标签_属性名称_属性类型"
	    var searchAllFs="IP地址#ip#textField,开始日期#startDate#dateFieldShowTime,结束日期#endDate#dateFieldShowTime,用户名#personName#textField,帐号#personLoginName#textField".split(",");
    	//查询面板中默认显示的条件，格式同上
    	var searchDefaultFs="IP地址#ip#textField,开始日期#startDate#dateFieldShowTime,结束日期#endDate#dateFieldShowTime".split(",");
	</script>
