...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/DatapermForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			//var id = "${param.tableid}";//选择的表ID
			var tablename="${param.tablename}";
			var dmid="${param.dmid}";
			var datapermForm = new DatapermForm(dmid,tablename,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'权限维护',border:false,region:'north'});
