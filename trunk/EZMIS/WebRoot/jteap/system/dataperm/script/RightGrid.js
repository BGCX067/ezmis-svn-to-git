...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
			...
			'id','datapermname','datapermcname','sql','qualification','tablename','dorder'
	        ]),
	        remoteSort: true
	    });
		return ds;
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'datapermname',header: "权限名", width: 150, sortable: true, dataIndex: 'datapermname'},
				{id:'datapermcname',header: "权限中文名", width: 150, sortable: true, dataIndex: 'datapermcname'},
				{id:'sql',header: "sql", width: 250, sortable: true, dataIndex: 'sql'},
				{id:'qualification',header: "条件", width: 200, sortable: true, dataIndex: 'qualification'},
				{id:'tablename',header: "表名", width: 100, sortable: true, dataIndex: 'tablename',hidden:true},
