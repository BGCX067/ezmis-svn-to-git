...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/AddTableClassForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var addTableClassForm = new AddTableClassForm(id);
			var titlePanel=new Ext.app.TitlePanel({caption:'映射维护',border:false,region:'north'});
			
			var lyCenter = {
				id : 'center-panel',
				region : 'center',
				border : true,
				items:[addTableClassForm]
			}
			var viewport=new Ext.Viewport({
				layout:'border',
				items:[lyCenter,titlePanel]
			});
			
			addTableClassForm.loadData();
