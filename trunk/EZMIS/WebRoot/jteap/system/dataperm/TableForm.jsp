...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/TableForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var tableForm = new TableForm(dmid,tablename);
			var titlePanel=new Ext.app.TitlePanel({caption:'列表选择',border:false,region:'north'});
			var lyCenter = {
				id : 'center-panel',
				region : 'center',
				border : true,
