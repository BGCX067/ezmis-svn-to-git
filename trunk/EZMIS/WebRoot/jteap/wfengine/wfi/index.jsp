...
<html>
  ...
  <body scroll="no" id="index">
	...
	<script>
		var searchAllFs="流程名称#c.FLOW_TOPIC#textField,开始时间#START_#dateField,结束时间#END_#dateField".split(",");
    	var searchDefaultFs="流程名称#c.FLOW_TOPIC#textField,开始时间#START_#dateField,结束时间#END_#dateField".split(",");
	</script>
