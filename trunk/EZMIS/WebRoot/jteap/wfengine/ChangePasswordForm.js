...
var ChangePasswordFormWindow=function(){
	...
	//当前密码
	var txtCurPassword={xtype:'uniquetextfield',inputType:'password',url:link2,notUniqueText:'当前密码不正确',id:'txtCurPassword',fieldLabel:'当前密码',vtype:'alphanum',maxLength:10,minLength:5,minLengthText:'最少需要6位字母数字组合',maxLengthText:'最长10位字母数字组合',name:'userPassword',allowBlank:false,anchor:'90%'};
