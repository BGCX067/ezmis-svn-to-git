...
<html>
  ...
  <body scroll="no" id="index">
	...
	<script>
		var searchAllFs="流程主题#flowTopic#textField,流程名称#flowname#textField,当前环节#curTaskName#textField".split(",");
    	var searchDefaultFs="流程主题#flowTopic#textField,流程名称#flowname#textField,当前环节#curTaskName#textField".split(",");
	</script>
