...
<html>
  ...
  <body scroll="no">
	...
	<script type="text/javascript" src="script/WorkFlowCatalogTree.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/WorkFlowGrid.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){
			...
			var viewport=new Ext.Viewport({
				layout:'border',
				items:[lyCenter,workFlowCatalogTree,lyNorth]
			});
