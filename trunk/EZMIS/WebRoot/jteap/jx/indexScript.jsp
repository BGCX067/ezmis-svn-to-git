...
<script>
	...
	//请求个性化配置，加载个人配置信息
	var loadPerLink = "${contextPath}/jteap/system/preference/PreferenceAction!loadPreference.do";
	...
	//跳转子运行系统首页
	var link14="${contextPath}/jteap/system/resource/ModuleAction!showFunctionMenuTreeAction.do";
</script>
