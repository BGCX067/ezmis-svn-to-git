...
function btnDelSq_Click() {
	...
	if (window.confirm("确认删除选中的缺陷单草稿吗?")) {
		var myMask = showExtMask("缺陷单草稿删除中，请稍候。。。");
		// 提交数据
		Ext.Ajax.request({
					url : url,
					success : function(ajax) {
...
var searchAllFs = "设备名称#SBMC#textField,缺陷名称#QXMC#textField,状态#STATUS#textField,发送人#POST_PERSON#textField,缺陷单号#QXDBH#textField".split(",");
var searchDefaultFs = "设备名称#SBMC#textField,缺陷名称#QXMC#textField,状态#STATUS#textField,发送人#POST_PERSON#textField,缺陷单号#QXDBH#textField".split(",");
