 ...
 * 下载缺陷查询数据
 */
function btnExpQxcx_Click() {
	var path = contextPath +"/jteap/jx/qxgl/QxcxAction!exportExcelByTj.do";
	window.open(path);
}
/**
 * 新建缺陷统计
...
function btnAddQxtj_Click() {
	var url = contextPath + "/jteap/form/eform/eformRec.jsp?formSn=" + "TB_JX_QXGL_QXTJ_TMP";
