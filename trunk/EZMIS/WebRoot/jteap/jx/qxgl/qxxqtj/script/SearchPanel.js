		...
		Ext.each(oItems, function(oItem) {
					if (oItem.hidden == false) {
						...
						if (tempValue != null && tempValue != "") {
							if (temp.id.split("#")[1] == "tbr") {
								queryParamsSql += " a." + temp.id.split("#")[1] + " like '"
										+ encodeURIComponent("%" + tempValue + "%") + "' and ";
							} else if (temp.id.split("#")[1] == "dctjq") {
								var dt = formatDate(new Date(tempValue), "yyyy-MM");
								queryParamsSql += " a." + temp.id.split("#")[1] + " = '" + dt + "' and ";
							} else if (temp.id.split("#")[1] == "tjsj") {
