...
CDrag.Table.Rows.prototype = {
 ...
 //初始化信息
  ...
  if (wc.window == 0) {
   ...
   wc.reduce.innerHTML = "<img src='images/expand.png' />";
  } else {
   wc.content.style.display = "block";
   wc.reduce.innerHTML = "<img src='images/collapse.png' />";
  }
 ...
 //获取相关信息
  ...
  wc.title.innerHTML = "<img src='"+info.icon+"'>"+info.title;
...
CDrag.prototype = {
 ...
 //变大变小
  ...
  if ((o.window = (o.window == 1 ? 0 : 1))) {
   ...
   //展开时刷新
   o.content.childNodes[0].contentDocument.location.reload();
   o.reduce.innerHTML = "<img src='images/collapse.png' />";
  } else {
   o.content.style.display = "none";
   o.reduce.innerHTML = "<img src='images/expand.png' />";
  }
  wc.set_cookie();
 },
...
quick: function(o){
 ...
 //设置COOKIE
  ...
  var tempCookie = "CDrag=" + wc.create_json() + ";expires=" + date.toGMTString();  
  //取消cookie
  ...
  Ext.Ajax.request({
  	url: link15,
  	params: {personId:curPersonId, config:tempCookie},
  	method: 'post',
...
//我的快捷
var myQuickUrl = contextPath + "/jteap/index/myQuick/index.jsp";
//待办/已办
var deals = contextPath + "/jteap/index/deals/index2.jsp";
//机组负荷曲线
var jizuFhqx = contextPath +"/jteap/index/jizuFhqx/allJzfh.jsp";
//实时信息
var nowInfo = contextPath + "/jteap/index/nowInfo/index.jsp";
//生产综合信息
var scZhxx = contextPath + "/jteap/index/scZhxx/index.jsp";
//常用查询
var query = contextPath + "/jteap/index/query/index.jsp";
//系统通知
var tongzhi = contextPath + "/jteap/index/tongzhi/index.jsp";

CDrag.database.json = [
  
 { id : "m_1_1", icon : "images/myQuick.gif", title : "我的快捷", className : "<iframe id='myQuickIF' src='"+ myQuickUrl +"' width='100%'  height='"+root_height*0.35+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : ""},
 
 { id : "m_1_2", icon : "images/Phone_30.jpg", title : "系统通知", className : "<iframe id='tongzhiIF' src='"+ tongzhi +"' width='100%'  height='"+root_height*0.3+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : ""},
 
 { id : "m_1_3", icon : "images/query.gif", title : "电厂应用系统", className : "<iframe id='queryIF' src='"+ query +"' width='100%'  height='"+root_height*0.2+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : "" },
 
 { id : "m_2_1", icon : "images/other.gif", title : "待办/已办", className : "<iframe id='dbybIF' src='"+ deals +"' width='100%'  height='"+root_height*0.5+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : "" },
 
 { id : "m_2_2", icon : "images/jizuFhqx.gif", title : "机组负荷曲线", className : "<iframe id='jizuFhqxIF' src='"+ jizuFhqx +"' width='100%'  height='"+root_height*0.4+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : "" },
 
 { id : "m_3_1", icon : "images/nowInfo.gif", title : "实时信息", className : "<iframe id='nowInfoIF' src='"+ nowInfo +"' width='100%'  height='"+root_height*0.45+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : "" },
 
 { id : "m_3_2", icon : "images/scZhxx.gif", title : "生产综合信息", className : "<iframe id='scZhxxIF' src='"+ scZhxx +"' width='100%'  height='"+root_height*0.45+"' frameborder='0' scrolling='no'>&nbsp;</iframe>", src : "" }
