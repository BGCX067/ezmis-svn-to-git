...
<script>
	...
	// 查看全厂
	var link2="${contextPath}/jteap/gcht/htsp/HeTongShenPiAction!showQcHeTongAction.do?tableName=TB_HT_GCHT";
	...
	// 合同付款列表页面
	var link5="${contextPath}/jteap/gcht/zhcx/jbxxcx/wzhtcx/htFkGrid.jsp?tableName=TB_HT_GCHTFK";
