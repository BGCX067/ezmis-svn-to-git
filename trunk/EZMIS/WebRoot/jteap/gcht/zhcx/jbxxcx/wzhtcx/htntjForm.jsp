					...
					<div class="pop-title">
					    ...
					    <table width="97%" height="40%" align="center" class="LabelBodyTb">
					    	...
					    	<tr>
					    		...
					    		<td class="POPtab-Title">合同总金额</td>
					    		<td class="POPtabTbEntry2"><div id="divHtZje"></div></td>
					    	</tr>
					    	<tr>
					    	...
					    	<tr>
					    		...
					    		<td class="POPtab-Title">总支付金额</td>
					    		<td class="POPtabTbEntry2"><div id="divZzfje"></div></td>
					    	</tr>
					    </table>
				    <div class="pop-but">
