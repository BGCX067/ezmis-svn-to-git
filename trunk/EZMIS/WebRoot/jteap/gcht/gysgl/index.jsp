...
<html>
  ...
  <jteap:dict catalog="GCHT_QYLX"></jteap:dict>
  <body scroll="no" id="index">
	...
	<div id="loading">
	  <div class="loading-indicator">
		...
		String chooseFlbm = request.getParameter("chooseFlbm");
	%>
	<script type="text/javascript">
		var chooseFlbm = "<%=chooseFlbm%>";
	</script>
    ...
    <script type="text/javascript">
		Ext.onReady(function(){			
			...
			var viewport=new Ext.Viewport({
				layout:'border',
				items:[lyCenter<c:if test="${!isQuery}">,lyNorth</c:if>,leftTree]
			});
