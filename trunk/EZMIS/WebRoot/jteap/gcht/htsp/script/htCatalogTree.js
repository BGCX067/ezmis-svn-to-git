	...
	treeEditor.on("beforecomplete",function(editor,value,oldValue){
		...
		if(bFlag){
		 	...
		 	Ext.Ajax.request({
		 		...
		 		method:'POST',
		 		params:{nodeName:value,id:editor.editNode.id.indexOf("ynode")>=0?"":editor.editNode.id,flbm:flbm}
		 	})
		 	bFlag=false;
		 }
    });    
