...
RightGrid = function() {
	...
	this.getSelectionModel().on("selectionchange", function(oCheckboxSModel) {
				...
				//新增子合同
				var btnXjzHt = mainToolbar.items.get("btnXjzHt");
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS : function(status, params) {
		...
		if(status == 'dsp') {
			url = link1;
			procFields = ["ID", "HTBH", "HTMC","HTLX","HTJE","GFDW", "SQBM", "STATUS","HTCJSJ", 
