...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS : function(status, params) {
		...
		if(status == 'dsp') {
			url = link1;
			procFields = ["ID","GCXMBH","GCXMMC","SGDW", "KGSJ","JGSJ","CJSJ","STATUS",
						"FLOW_TOPIC", "TASKTODOID", "FLOW_NAME","FLOW_INSTANCE_ID",
						"CURRENT_TASKNAME", "POST_PERSON", "POST_TIME", "TOKEN", "CURSIGNIN"];
		}else{
			procFields = ["ID","GCXMBH","GCXMMC","SGDW", "KGSJ","JGSJ","CJSJ","STATUS","ISZF",
	...
	getColumnModel : function(status) {
		...
		if (status == 'dsp') {
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'GCXMBH',header : "项目编号",width : 120,sortable : true,dataIndex : 'GCXMBH'}, 
				{id : 'GCXMMC',header : "项目名称",width : 120,sortable : true,dataIndex : 'GCXMMC'}, 
				{id : 'SGDW',header : "施工单位",width : 150,sortable : true,dataIndex : 'SGDW'}, 
				{id : 'KGSJ',header : "开工时间",width : 100,sortable : true,dataIndex : 'KGSJ'}, 
				{id : 'JGSJ',header : "竣工时间",width : 100,sortable : true,dataIndex : 'JGSJ'},
			...
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'JGSJ',header : "竣工时间",width : 100,sortable : true,dataIndex : 'JGSJ'},
				{id : 'STATUS',header : "审批状态",width : 140,sortable : true,dataIndex : 'STATUS'},
				{id : 'ISZF',header : "是否支付",width : 140,sortable : true,dataIndex : 'ISZF',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						 	if(value == '已支付'){
