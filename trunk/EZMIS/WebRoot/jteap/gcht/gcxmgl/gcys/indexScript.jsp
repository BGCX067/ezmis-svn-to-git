...
<script>
	// 查看当前登录人的待审批项目
	var link1="${contextPath}/jteap/gcht/gcxmgl/GcysAction!showDspHeTongAction.do";

	// 查看已审批项目
	var link2="${contextPath}/jteap/gcht/gcxmgl/GcysAction!showYspHeTongAction.do";
	
	// 查看草稿箱
	var link3="${contextPath}/jteap/gcht/gcxmgl/GcysAction!showCgxHeTongAction.do";
	
	// 释放签收
	var link4="${contextPath}/jteap/wfengine/tasktodo/TaskToDoAction!releaseSignInAction.do";
	
	// 查看全厂
	var link5="${contextPath}/jteap/gcht/gcxmgl/GcysAction!showQcHeTongAction.do";
	
	// 查看作废
	var link6="${contextPath}/jteap/gcht/gcxmgl/GcysAction!showYzfHeTongAction.do";
	
	// 作废项目审批
	var link7="${contextPath}/jteap/gcht/gcxmgl/GcysAction!cancelHeTongAction.do";
	...
	//查看终结
	var link17="${contextPath}/jteap/gcht/gcxmgl/GcysAction!showYzjHeTongAction.do";
	
	//选择已开工签证的的项目
	var link18="${contextPath}/jteap/gcht/gcxmgl/GcysAction!chooseXmAction.do";
</script>