...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS : function(status, params) {
		...
		if(status == 'dsp') {
			url = link1;
			procFields = ["ID", "GCMC", "BZNR", "BJJE","CJDW","SHNR","SHJE","STATUS","HTCJSJ",
	...
	getColumnModel : function(status) {
		...
		if (status == 'dsp') {
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'GCMC',header : "工程名称",width : 100,sortable : true,dataIndex : 'GCMC'}, 
				{id : 'CJDW',header : "承接单位",width : 80,sortable : true,dataIndex : 'CJDW'}, 
				{id : 'BZNR',header : "编制",width : 100,sortable : true,dataIndex : 'BZNR'}, 
				{id : 'BJJE',header : "金额",width : 100,sortable : true,dataIndex : 'BJJE'}, 
				{id : 'SHNR',header : "审核",width : 80,sortable : true,dataIndex : 'SHNR'}, 
				{id : 'SHJE',header : "金额",width : 60,sortable : true,dataIndex : 'SHJE'}, 
