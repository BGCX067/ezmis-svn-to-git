...
RightGrid=function(){
	...
	if(select){
		var kgid  = select.json.ID;
		Ext.Ajax.request({
			url:link2,
			method:'POST',
		 	params: {kgid:kgid},// Ext.util.JSON.encode(selections.keys)
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
	        ...
	        reader: new Ext.data.JsonReader({
				...
				"ID", "GCXMBH", "GCXMMC", "GCCBDW", "JHKGRQ","JHGQ","SQBM","XMFZR","XMYJ","CJSJ","STATUS","ISYS"
	        ]),
	        remoteSort: true,
	...
	getColumnModel:function(){
	    ...
	    var cm=new Ext.grid.ColumnModel([
				...
				*/
				...
				{id:'XMFZR',header: "申请人", width: 120, sortable: true, dataIndex: 'XMFZR' },
				...
				{id:'GCXMMC',header: "工程项目", width: 100, sortable: true, dataIndex: 'GCXMMC' },
