...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS : function(status, params) {
		...
		if(status == 'dsp') {
			url = link1;
			procFields = ["ID", "GCXMBH", "GCXMMC", "GCCBDW", "JHKGRQ","JHGQ","CJSJ","STATUS", 
						"FLOW_TOPIC", "TASKTODOID", "FLOW_NAME","FLOW_INSTANCE_ID",
						"CURRENT_TASKNAME", "POST_PERSON", "POST_TIME", "TOKEN", "CURSIGNIN"];
		}else{
			procFields = ["ID", "GCXMBH", "GCXMMC", "GCCBDW", "JHKGRQ","JHGQ","CJSJ","STATUS","ISYS",
	...
	getColumnModel : function(status) {
		...
		if (status == 'dsp') {
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'GCXMMC',header : "项目名称",width : 120,sortable : true,dataIndex : 'GCXMMC'}, 
				{id : 'GCCBDW',header : "承包单位",width : 100,sortable : true,dataIndex : 'GCCBDW'}, 
				{id : 'JHKGRQ',header : "计划开工日期",width : 100,sortable : true,dataIndex : 'JHKGRQ',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
					if(value != null){
						return formatDate(new Date(value),"yyyy-MM-dd HH:mm:ss");
					}
				}}, 
				{id : 'JHGQ',header : "计划工期",width : 100,sortable : true,dataIndex : 'JHGQ'},
			...
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'GCXMMC',header : "项目名称",width : 120,sortable : true,dataIndex : 'GCXMMC'}, 
				{id : 'GCCBDW',header : "承包单位",width : 100,sortable : true,dataIndex : 'GCCBDW'}, 
				{id : 'JHKGRQ',header : "计划开工日期",width : 120,sortable : true,dataIndex : 'JHKGRQ',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
					if(value != null){
						return formatDate(new Date(value),"yyyy-MM-dd HH:mm:ss");
					}
				...
				{id : 'JHGQ',header : "计划工期",width : 100,sortable : true,dataIndex : 'JHGQ'},
				{id : 'STATUS',header : "审批状态",width : 140,sortable : true,dataIndex : 'STATUS'},
				{id : 'ISYS',header : "是否验收",width : 140,sortable : true,dataIndex : 'ISYS',
					renderer:function(value,metadata,record,rowIndex,colIndex,store){
						 	if(value == '已验收'){
