...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS : function(status, params) {
		...
		if(status == 'dsp') {
			url = link1;
			procFields = ["ID", "HTMC", "CJDW", "HTJE", "ZBQX","ZBJED","SQRQ","STATUS","HTCJSJ",
	...
	getColumnModel : function(status) {
		...
		if (status == 'dsp') {
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'HTJE',header : "合同金额(元)",width : 100,sortable : true,dataIndex : 'HTJE'}, 
				{id : 'CJDW',header : "承接单位",width : 80,sortable : true,dataIndex : 'CJDW'}, 
				{id : 'ZBQX',header : "质保期限",width : 100,sortable : true,dataIndex : 'ZBQX'}, 
				{id : 'ZBJED',header : "质保金额度",width : 80,sortable : true,dataIndex : 'ZBJED'}, 
