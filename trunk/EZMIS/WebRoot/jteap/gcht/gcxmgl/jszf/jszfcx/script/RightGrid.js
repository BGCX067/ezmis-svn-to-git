...
RightGrid=function(){
	...
	if(select){
		var zfid  = select.json.ID;
		Ext.Ajax.request({
			url:link2,
			method:'POST',
		 	params: {zfid:zfid},// Ext.util.JSON.encode(selections.keys)
	...
	getDefaultDS:function(url){
	    var ds = new Ext.data.Store({
	        ...
	        reader: new Ext.data.JsonReader({
				...
				"ID", "XMBH","XMMC", "CBDW","SQBM","SQR","SQSJ","XMFYLY",
	...
	getColumnModel:function(){
	    ...
	    var cm=new Ext.grid.ColumnModel([
				...
				*/
				...
				{id:'XMFYLY',header: "工程类别", width: 100, sortable: true, dataIndex: 'XMFYLY'},
