...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS : function(status, params) {
		...
		if(status == 'dsp') {
			url = link1;
			procFields = ["ID","XMBH","XMMC","CBDW", "XMHTJE","YLJYFKJE","BCYFK","BCSFK","BCKK","CJSJ","STATUS","FQZT","ZFZT",
	...
	getColumnModel : function(status) {
		...
		if (status == 'dsp') {
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'YLJYFKJE',header : "累计付款",width : 100,sortable : true,dataIndex : 'YLJYFKJE'},
				{id : 'BCYFK',header : "本次应付款",width : 100,sortable : true,dataIndex : 'BCYFK'},
				{id : 'BCSFK',header : "本次实付款",width : 100,sortable : true,dataIndex : 'BCSFK'},
				{id : 'BCKK',header : "本次扣款",width : 100,sortable : true,dataIndex : 'BCKK'},
			...
			cm = new Ext.grid.ColumnModel([
				...
				{id : 'BCSFK',header : "本次实付款",width : 100,sortable : true,dataIndex : 'BCSFK'},
				{id : 'BCKK',header : "本次扣款",width : 100,sortable : true,dataIndex : 'BCKK'},
				{id : 'ZFZT',header : "支付状态",width : 140,sortable : true,dataIndex : 'ZFZT',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
						 	if(value == '支付完成'){
