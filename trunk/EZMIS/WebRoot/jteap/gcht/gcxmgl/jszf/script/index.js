...
var searchAllFs = "项目编号#GCXMBH#textField,项目名称#GCXMMC#textField,施工单位#SGDW#textField,创建年份#CJSJ#yearField".split(",");
var searchDefaultFs = "项目编号#GCXMBH#textField,项目名称#GCXMMC#textField,施工单位#SGDW#textField,创建年份#CJSJ#yearField".split(",");
