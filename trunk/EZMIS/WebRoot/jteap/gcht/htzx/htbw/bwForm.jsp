...
<html>
  ...
  <body scroll="no" id="index">
			...
			<div class="pop-in">
				<div class="pop-main">
				    ...
				    <table align="center" height="70%" width="97.5%" class="LabelBodyTb">
				    	<tr>
				    		<td class="POPtab-Title">合同名称</td>
				    		<td class="POPtabTbEntry2">
				    			<input type="text" id="txtHtmc">&nbsp;
				    			<input type="button" value="  ...  " class="pop-but01" style="height: 20px;" onclick="chooseHt()">
				    		</td>
				    	</tr>
				    	<tr>
				    		<td class="POPtab-Title">合同编号</td>
				    		<td class="POPtabTbEntry2">
								<input type="text" id="txtHtbh">&nbsp;
								<input type="button" value="  ...  " class="pop-but01" style="height: 20px;" onclick="chooseHt()">
							</td>
				    	</tr>
				    	<tr>
				    		<td class="POPtab-Title">备忘内容</td>
				    		<td class="POPtabTbEntry2"><div id="divBwnr"></div></td>
				    	</tr>
				    </table>
	...
	<script type="text/javascript" src="script/bwForm.js" charset="UTF-8"></script>
	<!-- 加载脚本库  结束 -->
