...
var searchAllFs = "合同编号#HTBH#textField,合同名称#HTMC#textField,合同类型#HTLX#textField,收款单位#SKDW#textField,创建年份#HTCJSJ#yearField".split(",");
var searchDefaultFs = "合同编号#HTBH#textField,合同名称#HTMC#textField,合同类型#HTLX#textField,收款单位#SKDW#textField,创建年份#HTCJSJ#yearField".split(",");
