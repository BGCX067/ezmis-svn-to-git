...
<html>
 ...
 <%
 	...
 	if("TB_HT_WZHTFK".equals(tableName)){
 		flowName = "物资合同付款审批";
 	}else if("TB_HT_GCHTFK".equals(tableName)){
 		flowName = "工程合同付款审批";
 	}else if("TB_HT_RLHTFK".equals(tableName)){
 		flowName = "燃料合同付款审批";
 	}else if("TB_HT_GCHTFKX".equals(tableName)){
 		flowName = "工程合同已完成付款审批";
 	}else if("TB_HT_ZFLFK".equals(tableName)){
 		flowName = "支付令";
 	}
