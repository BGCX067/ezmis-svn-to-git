...
var txtPjfl= new Ext.form.TextField({
	...
	listeners:{
		"beforerender":function(param){
			if(type == 'pj'){
				Ext.getCmp('txtPjfl').readOnly = true;
			}else{
				Ext.getCmp('txtPjfl').readOnly = false;
			}
		}
	}
});
...
var txtSbmc= new Ext.form.TextField({
	...
	listeners:{
		"beforerender":function(param){
			if(type == 'pj'){
				Ext.getCmp('txtSbmc').readOnly = true;
			}else{
				Ext.getCmp('txtSbmc').readOnly = false;
			}
		},
		"focus":function(){
			var obj = {};
...
var txtSbgg= new Ext.form.TextField({
	...
	listeners:{
		"beforerender":function(param){
			if(type == 'pj'){
				Ext.getCmp('txtSbgg').readOnly = true;
			}else{
				Ext.getCmp('txtSbgg').readOnly = false;
			}
		}
	}
});
...
var txtScpjrq= new Ext.form.DateField({
	...
	listeners:{
		"beforerender":function(param){
			if(type == 'pj'){
				Ext.getCmp('txtScpjrq').readOnly = true;
			}else{
				Ext.getCmp('txtScpjrq').readOnly = false;
			}
		}
	}
});
...
var txtScpjjb= new Ext.form.ComboBox({
    ...
    listeners:{
		"beforerender":function(param){
			if(type == 'pj'){
				Ext.getCmp('txtScpjjb').readOnly = true;
			}else{
				Ext.getCmp('txtScpjjb').readOnly = false;
			}
		}
	}
});
...
var txtScpjr= new Ext.form.TextField({
	...
	listeners:{
		"beforerender":function(param){
			if(type == 'pj'){
				Ext.getCmp('txtScpjr').readOnly = true;
			}else{
				Ext.getCmp('txtScpjr').readOnly = false;
			}
		}
	}
});
...
if(id != null){
	...
	if(type == "show"){
		txtPjfl.readOnly = true;
		txtSbmc.readOnly = true;
		txtSbgg.readOnly = true;
		txtScpjrq.readOnly = true;
		txtScpjjb.readOnly = true;
		txtScpjr.readOnly = true;
		txtBcpjrq.readOnly = true;
		txtBcpjjb.readOnly = true;
		txtBcpjr.readOnly = true;
