...
var searchOps = this;
	...
	this.searchClick=function(){
		...
		var queryParamsSql = "";
	 	...
	 	var url = link4+"?queryParamsSql="+queryParamsSql.substring(0,queryParamsSql.length-5)+"&limit=20&flbm="+searchOps.flbm;
	 	if(queryParamsSql.substring(0,queryParamsSql.length-5) == "" || queryParamsSql.substring(0,queryParamsSql.length-5) == null){
	 		queryParams = "sbpjCatalog.flbm like '"+searchOps.flbm+"%'";
	 	}else{
	 		queryParams = queryParamsSql.substring(0,queryParamsSql.length-5)+"and sbpjCatalog.flbm like '"+searchOps.flbm+"%'";
	 	}
