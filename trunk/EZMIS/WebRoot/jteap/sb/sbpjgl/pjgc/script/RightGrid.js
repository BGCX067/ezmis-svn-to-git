...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    ...
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'sbmc',header: "设备名称", width: 150, sortable: true, dataIndex: 'sbmc'},
				{id:'sbgg',header: "设备规格", width: 150, sortable: true, dataIndex: 'sbgg'},
				...
				{id:'one',header: "一类", width: 100, sortable: true, dataIndex: 'bcpjjb',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
					if(value == "一类"){
						return "<center><span style='color:red;font-weight:bolder;'>√</span></center>";
					}
				}},
				{id:'two',header: "二类", width: 100, sortable: true, dataIndex: 'bcpjjb',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
					if(value == "二类"){
						return "<center><span style='color:red;font-weight:bolder;'>√</span></center>";
					}
				}},
				{id:'three',header: "三类", width: 100, sortable: true, dataIndex: 'bcpjjb',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
					if(value == "三类"){
						return "<center><span style='color:red;font-weight:bolder;'>√</span></center>";
					}
				}},
				{id:'wd',header: "未定", width: 100, sortable: true, dataIndex: 'bcpjjb',
				renderer:function(value,metadata,record,rowIndex,colIndex,store){
					if(value == "未定"){
						return "<center><span style='color:red;font-weight:bolder;'>√</span></center>";
					}
