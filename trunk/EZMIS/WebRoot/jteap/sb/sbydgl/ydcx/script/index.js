...
var searchAllFs="设备名称#sbmc#textField,异动状态#status#comboBox,异动类型#type#comboBox,申请人#sqr#textField,开始日期#startDate#dateFieldShowTime,结束日期#endDate#dateFieldShowTime".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="设备名称#sbmc#textField,异动状态#status#comboBox,异动类型#type#comboBox,申请人#sqr#textField,开始日期#startDate#dateFieldShowTime,结束日期#endDate#dateFieldShowTime".split(",");
