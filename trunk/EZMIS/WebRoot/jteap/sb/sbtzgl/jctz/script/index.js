...
function btnAdd_Click(){
	...
	var url = contextPath + '/jteap/sb/sbtzgl/jctz/jctzinfo.jsp?sbtzCatalogId='+obj.sbtzCatalogId+"&type=addTz";;
...
function btnModify_Click(){
	...
	if(select){
		...
		var url = contextPath + '/jteap/sb/sbtzgl/jctz/jctzinfo.jsp' + "?modi=m&sbtzCatalogId="+obj.sbtzCatalogId+"&type=ModiTz";
		showIFModule(url,"基础台帐信息","true",500,360,obj);
		rightGrid.getStore().reload();
	}
