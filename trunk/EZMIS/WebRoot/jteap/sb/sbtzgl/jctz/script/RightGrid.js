...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
		...
		var url = contextPath + '/jteap/sb/sbtzgl/jctz/jctzinfo.jsp' + "?modi=m&sbtzCatalogId="+obj.sbtzCatalogId+"&type=show&sblx="+type;
		if(type == 2){
			showIFModule(url,"运行台帐信息","true",500,360,obj);
		}else{
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    ...
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'ybmc',header: "仪表名称", width: 100, sortable: true, dataIndex: 'ybmc'},
