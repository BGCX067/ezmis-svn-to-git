...
var searchAllFs="设备编码#sbbm#textField,设备名称#ybmc#textField,安装位置#azdd#textField".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="设备编码#sbbm#textField,设备名称#ybmc#textField,安装位置#azdd#textField".split(",");
