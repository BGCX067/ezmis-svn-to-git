...
function initToolbarButtonStatus(button){
	if(button.id=='btnDelCatalog' || button.id=='btnModiCatalog') {
		button.setDisabled(true);
	}
		
}
//查询面板中 所有的查询条件 格式："标签_属性名称_属性类型,标签_属性名称_属性类型,......标签_属性名称_属性类型"
var searchAllFs="标题#bt#textField,填写人#scr#textField,填写时间#scsj#textField".split(',');
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="标题#bt#textField,填写人#scr#textField,填写时间#scsj#textField".split(',');
