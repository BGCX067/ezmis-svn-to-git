...
<html>
	...
	<body scroll="no">
		...
		<table width="100%" height="100%">
						...
						<tr>
							...
							<td class="top-right">
								<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
									...
									width="564" height="93">
									<param name="movie" value="images/top-right-01-dgt.swf">
									<param name="quality" value="high">
									<param name=wmode value=transparent>
									<embed src="images/top-right-01-dgt.swf" quality="high"
			...
			<tr>
				<td height="70%">
					<IFRAME id='portal' name='portal' scrolling='no'
						src="menu.jsp?moduleId=<%=moduleId%>"
						style='width: 100%; height: 75%' frameborder='no'></IFRAME>
				</td>
			</tr>
			<tr>
