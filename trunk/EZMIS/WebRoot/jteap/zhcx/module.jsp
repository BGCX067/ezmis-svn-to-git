	...
	<body scroll="no">
		...
		<script type="text/javascript">
			...
			function toMaxRightFrameWindow(){
				if(sum % 2 == 1){
				   oldHeight= document.getElementById("rightModule").style.height;
				//最大化
				...
				//最小化
					...
					document.getElementById("rightModule").style.height = oldHeight;
					window.moveTo(oldX-2,oldY-25);//修正module页面在点击多个模块是放大缩小向上平移现象(oldY-30)改为(oldY-25)
					window.resizeBy(0,-300);
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="box1-tab" style="height:83%;">
						...
						<tr>
							...
							<td class="box1-main">
								...
								<IFRAME id='rightModule' name='rightModule' scrolling='yes' src="rightFrame.jsp?moduleId=<%=moduleId %>" style='height:100%;width:100%;' frameborder='yes'></IFRAME>
								</div>
								<!----------->
							</td>
							<td class="box1-right">
