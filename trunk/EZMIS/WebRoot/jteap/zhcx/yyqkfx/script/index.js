...
function btnAdd_Click() {
	var url = contextPath + "/jteap/form/eform/eformRec.jsp?formSn=" + "TB_FORM_SJBZB_YYFXB";
...
function btnMod_Click(){
	...
	var url = CONTEXT_PATH+"/jteap/form/eform/eformRec.jsp?formSn="+"TB_FORM_SJBZB_YYFXB"+"&docid="+id;
	var myTitle = "修改记录";
...
function btnDel_Click(){
	...
	var url = CONTEXT_PATH+"/jteap/form/eform/EFormAction!delEFormRecAction.do?formSn=TB_FORM_SJBZB_YYFXB";
	var myTitle = "删除记录";
	var ids="";
