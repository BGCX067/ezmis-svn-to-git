...
QxTree = function(chooseType, checkPath, checkLeaf ,roleid,textname,link) {
	...
	if (chooseType == 'single' || checkLeaf) {
		...
		var treeLoader=new Ext.app.CheckboxTreeNodeLoader( {
							dataUrl : link
						});
	...
	QxTree.superclass.constructor.call(this, {
		id : 'pTree',
		autoScroll : true,
		autoHeight : true,
		originalValue : "",
	...
	this.refreshTree=function(role_id){
		roleid=role_id;
		root.reload();
	}
...
Ext.extend(QxTree, Ext.tree.TreePanel, {

	checkPath : false,

	// 获得选中节点ID和TEXT
	getQxNameAndId : function() {
			var result = "";
			// 获得选中节点ID和TEXT
