...
Ext.extend(BbSjzdGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'fname',header: "数据项名", width: 100, sortable: true, dataIndex: 'fname'},
				{id:'cfname',header: "数据项中文名", width: 100, sortable: true, dataIndex: 'cfname'},
				{id:'ftype',header: "数据类型", width: 100, sortable: true, dataIndex: 'ftype'}
			]);
		return cm;
	},
	/**
