...
<html>
  ...
  <body>
	...
	<script type="text/javascript" src="script/bbsjydyForm.js" charset="UTF-8"></script>
	<!-- 入口程序 -->
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var bbindexid="${requestScope.bbindexid}";
			...
			//alert(oXmlDoc);
			var bbsjydyForm = new BbsjydyForm(id,bbindexid,isSql,strSql,true);
