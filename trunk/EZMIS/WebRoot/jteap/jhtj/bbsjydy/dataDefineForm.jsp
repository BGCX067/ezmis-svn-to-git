  ...
  <body scroll="yes">
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var id="${param.id}";
			var titlePanel=new Ext.app.TitlePanel({caption:'报表数据源维护',border:false,region:'north'});
			
			var lyCenter = {
				id : 'center-panel',
				region : 'center',
				border : true,
				html:'<iframe width="100%" height="100%" src="'+link11+'?bbindexid='+bbindexid+'&isUpdate='+isUpdate+'&id='+id+'"></iframe>'
			}
