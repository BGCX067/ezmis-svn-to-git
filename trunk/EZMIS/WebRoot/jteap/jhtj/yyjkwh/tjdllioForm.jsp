...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/tjdllioForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			var tjdllioid="${param.tjdllioid}";
			var tjdllioForm = new TjdllioForm(tjdllioid,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'应用接口维护',border:false,region:'north'});
