...
LeftTree= function(){
    ...
    this.getSelectionModel().on("selectionchange",function(oSM,oNode){
		...
		var btnAddTest=mainToolbar.items.get("btnAddTest");
		var btnModiTest=mainToolbar.items.get("btnModiTest");
		var btnDelTest=mainToolbar.items.get("btnDelTest");
		...
		if(oNode==null){
			...
			if(btnAddTest) btnDelCatalog.setDisabled(true);
			if(btnModiTest) btnDelCatalog.setDisabled(true);
			if(btnDelTest) btnDelCatalog.setDisabled(true);
