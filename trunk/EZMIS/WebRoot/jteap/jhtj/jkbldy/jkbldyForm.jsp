...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/jkbldyForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			var jkbldyid="${param.jkbldyid}";
			var jkbldyForm = new JkbldyForm(jkbldyid,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'接口变量维护',border:false,region:'north'});
