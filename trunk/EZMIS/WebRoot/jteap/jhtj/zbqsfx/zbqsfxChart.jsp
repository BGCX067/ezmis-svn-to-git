...
<html>
  ...
  <div style="display:none">
	  <form action="${contextPath}/jteap/jhtj/zbqsfx/zbqsfxAction!showIndexAction.do" name="backForm">
...
<script type="text/javascript" src="${contextPath}/script/ext-extend/form/SearchPanel.js"></script>
	...
	<script type="text/javascript" src="${contextPath}/jteap/jhtj/zbqsfx/script/SearchPanel.js"></script>
	<script type="text/javascript" src="${contextPath}/jteap/jhtj/zbqsfx/script/zbqsfxChart.js" charset="UTF-8"></script>
	<script type="text/javascript" src="${contextPath}/jteap/jhtj/zbqsfx/script/zbqsfxOperation.js" charset="UTF-8"></script>
