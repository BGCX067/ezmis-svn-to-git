...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/tjAppSjzdForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			var id="${param.sjzdid}";
			var tjAppSjzdForm = new TjAppSjzdForm(id);
			var titlePanel=new Ext.app.TitlePanel({caption:'数据字段维护',border:false,region:'north'});
