...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/sjflszForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var sjflszForm = new SjflszForm(parentId,id,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'数据分类维护',border:false,region:'north'});
