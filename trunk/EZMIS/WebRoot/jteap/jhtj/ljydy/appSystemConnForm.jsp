...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/appSystemConnForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			var connid="${param.connid}";
			var isEdit="${param.isEdit}";
			var appSystemConnForm = new AppSystemConnForm(connid,isEdit);
			var titlePanel=new Ext.app.TitlePanel({caption:'应用系统连接',border:false,region:'north'});
			
			var lyCenter = {
				id : 'center-panel',
				region : 'center',
				border : true,
				items:[appSystemConnForm]
			}
