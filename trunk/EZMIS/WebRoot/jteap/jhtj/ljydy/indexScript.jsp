...
<jteap:operations/>
<script>	
	var link1="${contextPath}/jteap/jhtj/ljydy/appSystemConnAction!showTreeAction.do";
	
	var link2="${contextPath}/jteap/jhtj/ljydy/appSystemConnAction!deleteNodeAction.do";
	
	var link3="${contextPath}/jteap/jhtj/ljydy/appSystemConnAction!saveUpdateAction.do";

	var link4="${contextPath}/jteap/jhtj/ljydy/appSystemFieldAction!showListAction.do";
