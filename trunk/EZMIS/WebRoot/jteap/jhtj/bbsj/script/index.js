 ...
 * 添加EForm表单
 */
function btnImportCatalog_Click(){
	var title="报表数据源维护";
 ...
 * 修改表单
 */
function btnDesignCatalog_Click(){
	var title="报表数据源维护";
...
var lyCenter = {
	...
	region : 'center',
	border : true,
	html:'<iframe width="100%" height="100%" name="excelFrame" src=""></iframe>'
}
//北边
var lyNorth={
	id:'north-panel',
