...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="script/BbIOGrid.js" charset="UTF-8"></script>    
    <script type="text/javascript" src="script/BbSjzdGrid.js" charset="UTF-8"></script>    
    <script type="text/javascript" src="script/dataSelectIndex.js" charset="UTF-8"></script>    
	<!-- 入口程序 -->
    <script type="text/javascript">
    	var dataSelectIndex;
    	Ext.onReady(function(){			
			Ext.QuickTips.init();
			var titlePanel=new Ext.app.TitlePanel({caption:'报表数据源',border:false,region:'north'});
			dataSelectIndex=new DataSelectIndex();
			var lyCenter = {
				id : 'center-panel',
				region : 'center',
				border : true,
				items:[dataSelectIndex]
			}
