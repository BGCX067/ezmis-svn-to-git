...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/statusForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			var id="${param.id}";
			var statusForm = new StatusForm(id,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'状态设置',border:false,region:'north'});
