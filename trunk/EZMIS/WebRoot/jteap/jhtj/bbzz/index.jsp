...
<html>
  ...
  <body scroll="no">
	...
	<script type="text/javascript">
		var searchAllFs="报表中文名#cname#textField,制作日期#zbrq#dateField,状态#status#comboBox".split(",");
	    var searchDefaultFs="报表中文名#cname#textField,制作日期#zbrq#dateField,状态#status#comboBox".split(",");
	</script>
