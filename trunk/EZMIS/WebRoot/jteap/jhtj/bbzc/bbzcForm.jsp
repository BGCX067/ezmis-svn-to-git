...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/bbzcForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var bbzcForm = new BbzcForm(id,parentId,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'报表分类',border:false,region:'north'});
