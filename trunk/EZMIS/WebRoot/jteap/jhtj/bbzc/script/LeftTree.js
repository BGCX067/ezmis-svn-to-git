...
LeftTree= function(){
    ...
    this.getSelectionModel().on("selectionchange",function(oSM,oNode){
		...
		var btnAddBb=mainToolbar.items.get("btnAddBb");
		...
		if(oNode==null){
			...
			if(btnAddBb) btnAddBb.setDisabled(true);
