...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/bbindexForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var id="${param.id}";
			var flid="${param.flid}";
			var bbindexForm = new BbindexForm(id,flid,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'报表注册信息',border:false,region:'north'});
