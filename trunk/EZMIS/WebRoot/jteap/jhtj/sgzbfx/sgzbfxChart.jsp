...
<html>
  ...
  <div style="display:none">
	  <form action="${contextPath}/jteap/jhtj/sgzbfx/sgzbfxAction!showIndexAction.do" name="backForm">
...
<script type="text/javascript" src="${contextPath}/script/ext-extend/form/SearchPanel.js"></script>
	...
	<script type="text/javascript" src="${contextPath}/jteap/jhtj/sgzbfx/script/SearchPanel.js"></script>
	<script type="text/javascript" src="${contextPath}/jteap/jhtj/sgzbfx/script/sgzbfxChart.js" charset="UTF-8"></script>
	<script type="text/javascript" src="${contextPath}/jteap/jhtj/sgzbfx/script/sgzbfxOperation.js" charset="UTF-8"></script>
