...
<html>
	...
	<script language="javascript">
  	...
  	<script type="text/javascript" src="script/sgzbfxIndex.js" charset="UTF-8"></script>
	<body style="margin-left: 0; margin-top: 0" onload="cteateFieldList();">
		<form action="${contextPath}/jteap/jhtj/sgzbfx/sgzbfxAction!showChartAction.do" method="post" target="excelFrame">
