...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/computeGrid.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/computeForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		var computeForm = new ComputeForm(id,true);
    	
		Ext.onReady(function(){			
			Ext.QuickTips.init();
			var titlePanel=new Ext.app.TitlePanel({caption:'计算公式设置',border:false,region:'north'});
