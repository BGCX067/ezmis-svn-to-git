...
<html>
  ...
  <body scroll="yes">
	...
	<script type="text/javascript" src="script/sjxxxdyForm.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
		...
		Ext.onReady(function(){			
			...
			var id="${param.id}";
			var kid="${param.kid}";
			var sjxxxdyForm = new SjxxxdyForm(id,kid,true);
			var titlePanel=new Ext.app.TitlePanel({caption:'信息项基本参数设置',border:false,region:'north'});
