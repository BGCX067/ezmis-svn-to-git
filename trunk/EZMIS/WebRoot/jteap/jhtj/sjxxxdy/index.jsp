...
<html>
  ...
  <body scroll="no">
	...
	<script type="text/javascript">
		var searchAllFs="信息项编码#item#textField,信息项名称#iname#textField,业务类型#sjlx#ywlxComboBox,取数方式#qsfs#qsfsComboBox".split(",");
	    var searchDefaultFs="信息项编码#item#textField,信息项名称#iname#textField,业务类型#sjlx#ywlxComboBox,取数方式#qsfs#qsfsComboBox".split(",");
