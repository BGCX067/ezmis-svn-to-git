PzcxGrid = function(tableName, tableCnName) {
	var defaultDs = this.getDefaultDS(link2+"?cxid=qc&tableName="+tableName+"&tableCname="+encodeURIComponent(tableCnName));
	defaultDs.load();
	var grid = this;
	...
	PzcxGrid.superclass.constructor.call(this, {
		ds : defaultDs,
...
Ext.extend(PzcxGrid, Ext.grid.GridPanel, {
