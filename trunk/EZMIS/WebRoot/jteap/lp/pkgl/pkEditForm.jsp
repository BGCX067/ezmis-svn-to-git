...
<html>
  ...
  <body scroll="no" id="index" onload="load()">
				...
				<div class="pop-main">
				    ...
				    <table width="100%" height="80%" align="center"class="LabelBodyTb">
				    	<tr>
				    		...
				    		<td class="POPtabTbEntry2"><div id="divPmc" style="float:left"></div><div id="divChoose"></div></td>
				    	</tr>
				    	<tr>
	...
	<script type="text/javascript" src="script/pkEditForm.js" charset="UTF-8"></script>
