...
<script>
	// 查看当前登录人的待处理工作票
	var link1="${contextPath}/jteap/lp/gzpgl/GzpglAction!showDclGzpAction.do";

	// 查看已处理工作票
	var link2="${contextPath}/jteap/lp/gzpgl/GzpglAction!showYclGzpAction.do";
	
	// 查看草稿箱
	var link3="${contextPath}/jteap/lp/gzpgl/GzpglAction!showCgxAction.do";
	
	// 释放签收
	var link4="${contextPath}/jteap/wfengine/tasktodo/TaskToDoAction!releaseSignInAction.do";
	
	// 查看全厂
	var link5="${contextPath}/jteap/lp/gzpgl/GzpglAction!showQcAction.do";
	
	// 查看作废
	var link6="${contextPath}/jteap/lp/gzpgl/GzpglAction!showZfGzpAction.do";
	
	// 作废工作票
	var link7="${contextPath}/jteap/lp/gzpgl/GzpglAction!cancelGzpAction.do";
	...
	// 工作票票库查看页面
	var link11="${contextPath}/jteap/lp/gzpgl/pkgl.jsp";
