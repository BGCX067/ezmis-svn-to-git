...
RightGrid=function(){
	...
	this.on("celldblclick",function(grid, rowIndex, columnIndex, e){
	    ...
	    if(select!=null){
		    ...
		    //var url=CONTEXT_PATH+ "/jteap/form/eform/eformRec.jsp?formSn=TB_FORM_SJBZB_FXB&docid="+id;
			//new $FW({url:url}).show();
	    }
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm=new Ext.grid.ColumnModel([
				...
				{id:'JZBH',header: "机组编号", width: 100, sortable: true, dataIndex: 'JZBH'},
				{id:'ZRBM',header: "责任编码", width: 100, sortable: true, dataIndex: 'ZRBM'},
				{id:'XZ',header: "性质", width: 100, sortable: true, dataIndex: 'XZ'}
			]);
		return cm;
	},
	/**
