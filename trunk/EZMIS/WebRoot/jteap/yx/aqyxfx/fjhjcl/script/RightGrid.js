...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getColumnModel:function(){
	    var cm =  new Ext.grid.ColumnModel([
				...
				{id:'TXR',header: "填写人", width: 80, sortable: true, dataIndex: 'TXR'},
				{id:'KSRQ',header: "开始日期", width: 150, sortable: true, dataIndex: 'KSRQ'},
				{id:'JSRQ',header: "结束日期", width: 150, sortable: true, dataIndex: 'JSRQ'}
			]);
		return cm;
	},
	/**
