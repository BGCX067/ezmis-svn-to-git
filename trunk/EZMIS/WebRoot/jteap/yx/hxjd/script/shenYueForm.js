 ...
 * 领导审阅窗口
 */
var ShenYueFormWindow=function(id){
	...
	var simpleForm = new Ext.FormPanel({
		...
		buttons: [{
			...
			handler:function(){
				...
				Ext.Ajax.request({
            		url:link3,
            		params: {userLoginName:$("userLoginName").value, userPassword:$("userPassword").value,
            				formSn:formSn,id:id,nowYmdHms:new Date().format("Y-m-d H:i:s")},
            		method:'post',
