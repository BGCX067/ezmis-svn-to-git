...
<html>
  ...
  <body scroll="no" id="index">
	...
	<script type="text/javascript" src="script/detailSearchPanel.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/detailGrid.js" charset="UTF-8"></script>
	<script type="text/javascript" src="script/detail.js" charset="UTF-8"></script>
