...
function btnAdd_Click() {
	var url = link2;
	var retValue = showModule(url, true, 580, 370);
	if (retValue) {
...
var searchAllFs = "开始时间#kssj1#dateFieldShowTime,至#kssj2#dateFieldShowTime,机组#jz#comboboxJz".split(',');
var searchDefaultFs = "开始时间#kssj1#dateFieldShowTime,至#kssj2#dateFieldShowTime,机组#jz#comboboxJz".split(',');
