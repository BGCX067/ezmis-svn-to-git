...
function btnAdd_Click() {
	var url = link2;
	var retValue = showModule(url, true, 580, 330);
	if (retValue) {
...
var searchAllFs = "开始时间#kssj1#dateFieldShowTime,至#kssj2#dateFieldShowTime".split(',');
var searchDefaultFs = "开始时间#kssj1#dateFieldShowTime,至#kssj2#dateFieldShowTime".split(',');
