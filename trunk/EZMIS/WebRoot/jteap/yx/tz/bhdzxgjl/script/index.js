...
function btnAdd_Click() {
	...
	var retValue = showModule(url, true, "", "", "", "", "", sFeature);
	if (retValue) {
...
var searchAllFs = "设备名称#bhmc#textField,更改时间#ggsj1#dateFieldShowTime,至#ggsj2#dateFieldShowTime".split(",");
// 查询面板中默认显示的条件，格式同上
var searchDefaultFs = "设备名称#bhmc#textField,更改时间#ggsj1#dateFieldShowTime,至#ggsj2#dateFieldShowTime".split(",");
