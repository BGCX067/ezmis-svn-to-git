...
function btnAdd_Click() {
	var url = link2;
	var retValue = showModule(url, true, 580, 260);
	if (retValue) {
...
var searchAllFs = "时间#sj1#dateFieldShowTime,至#sj2#dateFieldShowTime,设备名称#sbmc#textField".split(',');
var searchDefaultFs = "时间#sj1#dateFieldShowTime,至#sj2#dateFieldShowTime,设备名称#sbmc#textField".split(',');
