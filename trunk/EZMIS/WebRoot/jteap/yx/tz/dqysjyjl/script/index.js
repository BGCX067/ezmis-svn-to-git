...
function btnAdd_Click() {
	var url = link2;
	var retValue = showModule(url, true, 580, 290);
	if (retValue) {
...
var searchAllFs = "借用时间#jysj1#dateFieldShowTime,至#jysj2#dateFieldShowTime".split(',');
var searchDefaultFs = "借用时间#jysj1#dateFieldShowTime,至#jysj2#dateFieldShowTime".split(',');
