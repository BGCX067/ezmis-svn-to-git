...
var searchAllFs="开始时间#beginYmd#dateField,结束时间#endYmd#dateField,填写人#cbr#textField,班次#zbbc#CobomBoxBC,机组#jzbh#CobomBoxJZ,值别#zbzb#ComboBoxZB,原因#YY#ComboBoxYY".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="开始时间#beginYmd#dateField,结束时间#endYmd#dateField,填写人#cbr#textField,班次#zbbc#CobomBoxBC,机组#jzbh#CobomBoxJZ,值别#zbzb#ComboBoxZB,原因#YY#ComboBoxYY".split(",");
