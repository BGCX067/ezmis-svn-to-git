	 			...
	 			if(tempValue!=null&&tempValue!=""){
		 			...
		 			if(temp.triggerClass=="x-form-date-trigger"){
		 				...
		 				if(temp.id.split("#")[1]=="beginYmd"){
		 					queryParamsSql+="&beginYmd="+tempValue;
		 				}else if(temp.id.split("#")[1]=="endYmd"){
		 					queryParamsSql+="&endYmd="+tempValue;
		 				}
		 			}else if(temp.id.split("#")[1]=="tianxieren"){
	 					queryParamsSql+="&tianxieren="+encodeURIComponent(tempValue);
	 				}
	 			}
	 		};
	 	});
