 ...
 */
RightGrid=function(){
	var url = link1 + "?queryParamsSql= to_char(a.ZBSJ,'yyyy-MM-dd')>= '"+ MonthFirstDay + "' and to_char(a.ZBSJ,'yyyy-MM-dd')<= '"+nowYmd+" ' "+"&formSn="+formSn;
...
Ext.extend(RightGrid, Ext.grid.GridPanel, {
	...
	getDefaultDS:function(url){
		var proFilds = ["ID","CBR","ZBBC","ZBZB","ZBSJ"];
	...
	getColumnModel:function(){
	    var cm =  new Ext.grid.ColumnModel([
				...
				{id:'ZBSJ',header: "填写时间", width: 150, sortable: true, dataIndex: 'ZBSJ',renderer:function(value){
				          var time=formatDate(new Date(value), "yyyy-MM-dd hh:mm:ss");return time;}},
