...
var searchAllFs="开始时间#beginYmd#dateField,结束时间#endYmd#dateField,填写人#CBR#textField,值班班次#ZBBC#ComboBoxZBBC,值班值别#ZBZB#ComboBoxZBZB".split(",");
//查询面板中默认显示的条件，格式同上
var searchDefaultFs="开始时间#beginYmd#dateField,结束时间#endYmd#dateField,填写人#CBR#textField,值班班次#ZBBC#ComboBoxZBBC,值班值别#ZBZB#ComboBoxZBZB".split(",");
