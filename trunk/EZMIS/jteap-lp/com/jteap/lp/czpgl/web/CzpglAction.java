package com.jteap.lp.czpgl.web;
...
public class CzpglAction extends AbstractAction {

	private CzpglManager czpglManager;
	 ...
	 * 时间 : Jul 19, 2010
	 */
	public String showDclCzpAction() throws Exception {
		...
		try {
			...
			for (Dict dict : lstCzp) {
				...
				sbSql.append("select ID, PH, BZMC, STATUS, to_char(JHKSSJ, 'yyyy-MM-dd') as JHKSSJ, to_char(JHJSSJ,'yyyy-MM-dd') as JHJSSJ, CZKSSJH, CZKSSJM, CZJSSJH, CZJSSJM, FZRMC ");
				sbSql.append(" from ");
			...
			Page page = czpglManager.pagedQueryTableData(sql, iStart, iLimit);
			...
			String json = JSONUtil.listToJson((List) page.getResult(), 
					...
					"POST_TIME", "TOKEN", "CURSIGNIN", "PH", "BZMC", "FZRMC", "JHKSSJ", "JHJSSJ", "CZKSSJH", "CZKSSJM", "CZJSSJH", "CZJSSJM", "FZRMC", "STATUS", "ID", "PMC", "curSignInName"});
	 ...
	 * 时间 : Jul 19, 2010
	 */
	public String showYclCzpAction() throws Exception {
		String limit = request.getParameter("limit");
		if (StringUtils.isEmpty(limit))
			limit = SystemConfig.getProperty("PAGE_DEFAULT_LIMIT");
	 ...
	 * 时间 : Jul 19, 2010
	 */
	public String showZfCzpAction() throws Exception {
		String limit = request.getParameter("limit");
		if (StringUtils.isEmpty(limit))
			limit = SystemConfig.getProperty("PAGE_DEFAULT_LIMIT");
	...
	public String cancelCzpAction() throws Exception {
		...
		try {
			...
			String sql = "update TB_LP_CZP_DZ t set t.status = '已作废' where t.id ='"+id+"'";
	...
	public String[] listJsonProperties() {
		return new String[] { "ID_", "VERSION_", "START_", "END_",
				...
				"FLOW_FORM_ID", "PH", "BZMC", "FZRMC", "JHKSSJ","time", "JHJSSJ", "CZKSSJH", "CZKSSJM", "CZJSSJH", "CZJSSJM", "FZRMC", "STATUS", "ID", "PMC"};
	}
	...
	public CzpglManager getCzpglManager() {
		return czpglManager;
	}

	public void setCzpglManager(CzpglManager czpglManager) {
		this.czpglManager = czpglManager;
	}
