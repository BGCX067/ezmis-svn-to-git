...
public class RljxNodeInitEventHandler extends InitNodeEventHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		try {
			...
			String sql = "update TB_LP_GZP_RLJX set status='"+status+"' where id='"+docid+"'";
	...
	private void clearYQ(Connection conn, String docid) throws SQLException {
		String sql = "update TB_LP_GZP_RLJX set YQZT='', BGZT='' where id='"+docid+"'";
		Statement st = conn.createStatement();
		st.executeUpdate(sql);
		st.close();
	}
