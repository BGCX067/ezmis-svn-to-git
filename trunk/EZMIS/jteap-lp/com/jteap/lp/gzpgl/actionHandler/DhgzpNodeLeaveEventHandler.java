...
public class DhgzpNodeLeaveEventHandler extends LeaveNodeEventHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		try {
			...
			String sql = "update TB_LP_GZP_DH set status='"+status+"' , shzt = '1' where id='"+docid+"'";
