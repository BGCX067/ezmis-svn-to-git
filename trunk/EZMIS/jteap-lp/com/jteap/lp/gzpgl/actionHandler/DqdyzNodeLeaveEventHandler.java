...
public class DqdyzNodeLeaveEventHandler extends LeaveNodeEventHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		try {
			...
			String sql = "update TB_LP_GZP_DQDYZ set status='"+status+"' , shzt = '1' where id='"+docid+"'";
