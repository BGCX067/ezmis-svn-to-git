 ...
 */
@Entity  
@Table(name="TB_WZ_XQJHSQ_OPERATION_LOG")
public class XqjhsqLog {
	...
	@Column(name="XQJHSQID")
	private String xqjhsqid;//需求计划申请id
	
	public String getXqjhsqid() {
		return xqjhsqid;
	}

	public void setXqjhsqid(String xqjhsqid) {
		this.xqjhsqid = xqjhsqid;
	}
