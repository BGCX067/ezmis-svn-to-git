...
public class PddManager extends HibernateEntityDao<Pdd>{
	public Collection<Pdd> findYhdglByParentId(String parentId){
		
		StringBuffer hql=new StringBuffer("from Pdd as g where ");
		Object args[]=null;
